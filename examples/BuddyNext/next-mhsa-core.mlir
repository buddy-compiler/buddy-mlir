...
func.func @kernel(%arg0: tensor<1x1x1024x1024xf32>, %arg1: tensor<1x1x1024x1024xf32>, %arg2: tensor<1x1x1024x1024xf32>, %arg3: tensor<1x12x1024x128xf32>, %arg4: tensor<1x12x1024x128xf32>) {
  ...
  %tensor_unranked = tensor.cast %154 : tensor<1x1024x1536xf32> to tensor<*xf32>
...
func.func @main() {
  ...
  %c0 = arith.constant dense<2.0> : tensor<1x1x1024x1024xf32>
  %c1 = arith.constant dense<3.0> : tensor<1x1x1024x1024xf32>
  %c2 = arith.constant dense<4.0> : tensor<1x1x1024x1024xf32>
  %c3 = arith.constant dense<5.0> : tensor<1x12x1024x128xf32>
  %c4 = arith.constant dense<6.0> : tensor<1x12x1024x128xf32>

  call @kernel(%c0, %c1, %c2, %c3, %c4) : (tensor<1x1x1024x1024xf32>, tensor<1x1x1024x1024xf32>, tensor<1x1x1024x1024xf32>, tensor<1x12x1024x128xf32>, tensor<1x12x1024x128xf32>) -> ()
