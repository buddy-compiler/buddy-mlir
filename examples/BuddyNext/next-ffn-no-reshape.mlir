...
func.func @kernel(%arg0: tensor<8960x1536xf32>, %arg1: tensor<1024x1536xf32>, %arg2: tensor<8960x1536xf32>, %arg3: tensor<1536x8960xf32>, %arg4: tensor<1536xf32>, %arg5: tensor<1536x1536xf32>) -> tensor<1024x1536xf32> {
  ...
  %175 = tosa.transpose %arg0 {perms = array<i32: 1, 0>} : (tensor<8960x1536xf32>) -> tensor<1536x8960xf32>
  ...
  %180 = tosa.mul %177, %179, %shift : (tensor<1024x8960xf32>, tensor<1024x8960xf32>, tensor<1xi8>) -> tensor<1024x8960xf32>
  %182 = tosa.transpose %arg2 {perms = array<i32: 1, 0>} : (tensor<8960x1536xf32>) -> tensor<1536x8960xf32>
  ...
  %186 = tosa.mul %180, %184, %shift : (tensor<1024x8960xf32>, tensor<1024x8960xf32>, tensor<1xi8>) -> tensor<1024x8960xf32>
  %188 = tosa.transpose %arg3 {perms = array<i32: 1, 0>} : (tensor<1536x8960xf32>) -> tensor<8960x1536xf32>
  ...
  %208 = tosa.transpose %arg5 {perms = array<i32: 1, 0>} : (tensor<1536x1536xf32>) -> tensor<1536x1536xf32>
