...
func.func @kernel(%arg0: tensor<8960x1536xf32>, %arg1: tensor<1024x1536xf32>, %arg2: tensor<8960x1536xf32>, %arg3: tensor<1536x8960xf32>, %arg4: tensor<1536xf32>, %arg5: tensor<1536x1536xf32>) {
...
func.func @main() {
  ...
  call @kernel(%c0, %c1, %c2, %c3, %c4, %c5) : (tensor<8960x1536xf32>, tensor<1024x1536xf32>, tensor<8960x1536xf32>, tensor<1536x8960xf32>, tensor<1536xf32>, tensor<1536x1536xf32>) -> ()
