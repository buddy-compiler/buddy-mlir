...
func.func @kernel(%arg0: tensor<1536x8960xf32>, %arg1: tensor<1024x1536xf32>, %arg2: tensor<1536x8960xf32>, %arg3: tensor<8960x1536xf32>, %arg4: tensor<1536xf32>, %arg5: tensor<1536x1536xf32>) {
  ...
  %tensor_unranked = tensor.cast %211 : tensor<1024x1536xf32> to tensor<*xf32>
...
func.func @main() {
  ...
  %c0 = arith.constant dense<2.0> : tensor<1536x8960xf32>
  %c1 = arith.constant dense<3.0> : tensor<1024x1536xf32>
  %c2 = arith.constant dense<4.0> : tensor<1536x8960xf32>
  %c3 = arith.constant dense<5.0> : tensor<8960x1536xf32>
  %c4 = arith.constant dense<6.0> : tensor<1536xf32>
  %c5 = arith.constant dense<7.0> : tensor<1536x1536xf32>

  call @kernel(%c0, %c1, %c2, %c3, %c4, %c5) : (tensor<1536x8960xf32>, tensor<1024x1536xf32>, tensor<1536x8960xf32>, tensor<8960x1536xf32>, tensor<1536xf32>, tensor<1536x1536xf32>) -> ()
