...
#define DEBUG_TYPE "matmuloptimize"
...
public:
  ...
  explicit MatMulOptPass(int64_t vecSizeParam, int64_t kernelMParam,
...
namespace mlir {
namespace buddy_llama {
void registerMatMulOptPass() { PassRegistration<MatMulOptPass>(); }
} // namespace buddy
} // namespace mlir
