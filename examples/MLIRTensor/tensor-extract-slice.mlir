...
func.func @main() {
  ...
  func.call @print_memref_f32(%print_out0) : (tensor<*xf32>) -> ()    
  ...
  func.call @print_memref_f32(%print_out1) : (tensor<*xf32>) -> ()
  ...
  func.call @print_memref_f32(%print_out2) : (tensor<*xf32>) -> ()
  ...
  func.call @print_memref_f32(%print_out3) : (tensor<*xf32>) -> ()
  ...
  func.call @print_memref_f32(%print_out4) : (tensor<*xf32>) -> ()
  ...
  func.call @print_memref_f32(%print_out5) : (tensor<*xf32>) -> ()
  func.return
