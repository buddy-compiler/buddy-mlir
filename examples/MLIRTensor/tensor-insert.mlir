// RUN: buddy-opt %s \
// RUN:     -arith-bufferize  -tensor-bufferize -linalg-bufferize -convert-vector-to-llvm \
// RUN:     -func-bufferize -buffer-deallocation -convert-linalg-to-loops -convert-scf-to-cf \
