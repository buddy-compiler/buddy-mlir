...
void Resize4DImplementation(int argc, char *argv[]) {
  ...
  intptr_t outputSize[2] = {150, 100};

  // {col_scaling_ratio, row_scaling_ratio}
  std::vector<float> scalingRatios = {0.25, 0.1}; 
...
int main(int argc, char *argv[]) {
  ...
  Resize4DImplementation(argc, argv);
