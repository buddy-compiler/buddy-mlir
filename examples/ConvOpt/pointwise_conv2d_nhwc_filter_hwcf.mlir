...
func.func @conv_2d_1x1(%input: tensor<1x4x5x2xf32>, %filter: tensor<1x1x2x7xf32>) -> tensor<1x4x5x7xf32> {
    ...
    %1 = linalg.conv_2d_nhwc_hwcf {strides = dense<[1,1]>: tensor<2xi64>, dilations = dense<[2,2]>: tensor<2xi64>} ins(%input, %filter : tensor<1x4x5x2xf32>, tensor<1x1x2x7xf32>) outs(%0 : tensor<1x4x5x7xf32>) -> tensor<1x4x5x7xf32>
