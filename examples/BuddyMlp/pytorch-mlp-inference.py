...
# ===---------------------------------------------------------------------------
#
# mlp inference with PyTorch runtime.
#
# ===---------------------------------------------------------------------------
...
# Load model
model = torch.load("./mlp-model.pth")
...
with torch.no_grad():
    # Flatten the image from (1, 1, 28, 28) to (1, 784) to match training data format
