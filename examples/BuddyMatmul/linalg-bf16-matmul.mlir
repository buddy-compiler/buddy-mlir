...
module {
  ...
  // True BF16 linalg matmul kernel - no unnecessary conversions
  func.func @linalg_bf16_matmul(
    ...
    // Direct BF16 matrix multiplication - linalg.matmul natively supports bf16!
    // This performs true bf16 computation throughout
