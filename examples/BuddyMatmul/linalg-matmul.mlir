...
module attributes {} {
  func.func private @Matmul(%arg0: tensor<1280x32xf16>, %arg1: tensor<32x1280xf16>) -> tensor<1280x1280xf16> attributes {} {
  ...
  func.func @forward(%arg0: tensor<1280x32xf16>, %arg1: tensor<32x1280xf16>) -> tensor<1280x1280xf16> {
    %0 = call @Matmul(%arg0, %arg1) : (tensor<1280x32xf16>, tensor<32x1280xf16>) -> tensor<1280x1280xf16>
