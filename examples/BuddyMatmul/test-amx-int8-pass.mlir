// REQUIRES: has_amx
// RUN: buddy-opt %s -matmul-amx-int8 \
...
//
// AMX INT8 Matrix Multiplication Example (using -matmul-amx-int8 pass)
// ====================================================================
// This file demonstrates automatic conversion from linalg.matmul (i8×i8→i32)
// to Intel AMX INT8 tile operations using the -matmul-amx-int8 pass.
//
...
module {
  ...
  func.func @amx_main() {
    ...
    // This linalg.matmul will be converted by the -matmul-amx-int8 pass
    // to use Intel AMX INT8 tile operations (amx.tile_muli)
    // The pass will automatically handle VNNI packing of B matrix
