...
#define N 19
#define K 70
extern void _mlir_ciface_kernel_matmul_3x19x70(MemRef2 *, MemRef2 *, MemRef2 *);
int launch(void) {
  ...
  nr_puts("cycles matmul_3x19x70: "); nr_hex64(nr_cycles()-start); nr_puts("\r\n");
  ...
  return print_check("matmul_3x19x70",errors,max_error);
}
