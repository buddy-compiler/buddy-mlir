...
int launch(void) {
  ...
  _mlir_ciface_kernel_matmul_16x2048x1024(&A,&B,&C);
  nr_puts("cycles matmul_16x2048x1024: "); nr_hex64(nr_cycles()-start); nr_puts("\r\n");
  ...
  return print_check("matmul_16x2048x1024",errors,max_error);
}
