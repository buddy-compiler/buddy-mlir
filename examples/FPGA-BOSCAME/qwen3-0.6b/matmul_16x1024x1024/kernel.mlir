...
module {
  func.func @kernel_matmul_16x1024x1024(%a: memref<16x1024xi8>,
      %b: memref<1024x1024xi8, strided<[1, 1024]>>,
      %c: memref<16x1024xi32>) attributes {llvm.emit_c_interface} {
    linalg.matmul ins(%a, %b : memref<16x1024xi8>, memref<1024x1024xi8, strided<[1, 1024]>>)
