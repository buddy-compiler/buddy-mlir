...
#define N 1024
#define K 2048
extern void _mlir_ciface_kernel_matmul_16x1024x2048_f32(MemRef2 *, MemRef2 *, MemRef2 *);
int launch(void) {
  ...
  _mlir_ciface_kernel_matmul_16x1024x2048_f32(&A,&B,&C);
  nr_puts("cycles matmul_16x1024x2048_f32: "); nr_hex64(nr_cycles()-start); nr_puts("\r\n");
  ...
  return print_check("matmul_16x1024x2048_f32",errors,max_error);
}
