...
int launch(void) {
  ...
  _mlir_ciface_kernel_matmul_16x1024x2048(&A,&B,&C);
  nr_puts("cycles matmul_16x1024x2048: "); nr_hex64(nr_cycles()-start); nr_puts("\r\n");
  ...
  return print_check("matmul_16x1024x2048",errors,max_error);
}
