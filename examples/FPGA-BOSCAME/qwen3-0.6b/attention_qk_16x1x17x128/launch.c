...
#define N 17
#define K 128
extern void _mlir_ciface_kernel_attention_qk_16x1x17x128(MemRef3*,MemRef3*,MemRef3*);
int launch(void) {
  ...
  _mlir_ciface_kernel_attention_qk_16x1x17x128(&A,&B,&C);
  ...
  return print_check("attention_qk_16x1x17x128",errors,max_error);
}
