...
#define N 16
#define K 128
extern void _mlir_ciface_kernel_attention_qk_16x16x16x128(MemRef3*,MemRef3*,MemRef3*);
int launch(void) {
  ...
  _mlir_ciface_kernel_attention_qk_16x16x16x128(&A,&B,&C);
  ...
  return print_check("attention_qk_16x16x16x128",errors,max_error);
}
