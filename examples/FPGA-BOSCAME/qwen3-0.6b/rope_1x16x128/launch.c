...
extern void _mlir_ciface_kernel_rope_1x16x128(MemRef4 *, MemRef2 *, MemRef2 *, MemRef4 *);
int launch(void) {
  ...
  for (int i=0; i<2048; ++i) { x[i]=(float)((i*5)%53-26)*0.03125f; out[i]=9999; }
  ...
  for (int s=0; s<1; ++s) for (int h=0; h<16; ++h) for (int k=0; k<64; ++k) {
