...
static uint64_t cycles[47], counts[47];
void qwen_profile_reset(void) {
  for (unsigned i=0; i<47; ++i) cycles[i]=counts[i]=0;
}
void qwen_profile_report(unsigned position) {
  ...
  if (counts[2]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_attention_qk_position_16x16x512x128 calls="); nr_hex64(counts[2]);
    nr_puts(" cycles="); nr_hex64(cycles[2]);
    nr_puts("\r\n");
  }
  if (counts[3]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_attention_qk_position_16x1x512x128 calls="); nr_hex64(counts[3]);
  ...
  if (counts[19]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_layout_k_16x512x128 calls="); nr_hex64(counts[19]);
    nr_puts(" cycles="); nr_hex64(cycles[19]);
    nr_puts("\r\n");
  }
  if (counts[20]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_16x1024x1024 calls="); nr_hex64(counts[20]);
    nr_puts(" cycles="); nr_hex64(cycles[20]);
    nr_puts("\r\n");
  }
  if (counts[21]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_16x1024x2048 calls="); nr_hex64(counts[21]);
    nr_puts(" cycles="); nr_hex64(cycles[21]);
    nr_puts("\r\n");
  }
  if (counts[22]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_16x1024x3072 calls="); nr_hex64(counts[22]);
    nr_puts(" cycles="); nr_hex64(cycles[22]);
    nr_puts("\r\n");
  }
  if (counts[23]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_16x2048x1024 calls="); nr_hex64(counts[23]);
    nr_puts(" cycles="); nr_hex64(cycles[23]);
    nr_puts("\r\n");
  }
  if (counts[24]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_16x3072x1024 calls="); nr_hex64(counts[24]);
    nr_puts(" cycles="); nr_hex64(cycles[24]);
    nr_puts("\r\n");
  }
  if (counts[25]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_1x1024x1024 calls="); nr_hex64(counts[25]);
    nr_puts(" cycles="); nr_hex64(cycles[25]);
    nr_puts("\r\n");
  }
  if (counts[26]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_1x1024x2048 calls="); nr_hex64(counts[26]);
    nr_puts(" cycles="); nr_hex64(cycles[26]);
    nr_puts("\r\n");
  }
  if (counts[27]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_1x1024x3072 calls="); nr_hex64(counts[27]);
    nr_puts(" cycles="); nr_hex64(cycles[27]);
    nr_puts("\r\n");
  }
  if (counts[28]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_1x151936x1024 calls="); nr_hex64(counts[28]);
    nr_puts(" cycles="); nr_hex64(cycles[28]);
    nr_puts("\r\n");
  }
  if (counts[29]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_1x2048x1024 calls="); nr_hex64(counts[29]);
    nr_puts(" cycles="); nr_hex64(cycles[29]);
    nr_puts("\r\n");
  }
  if (counts[30]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_matmul_1x3072x1024 calls="); nr_hex64(counts[30]);
    nr_puts(" cycles="); nr_hex64(cycles[30]);
    nr_puts("\r\n");
  }
  if (counts[31]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_quantize_16x1024 calls="); nr_hex64(counts[31]);
    nr_puts(" cycles="); nr_hex64(cycles[31]);
    nr_puts("\r\n");
  }
  if (counts[32]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_quantize_16x2048 calls="); nr_hex64(counts[32]);
    nr_puts(" cycles="); nr_hex64(cycles[32]);
    nr_puts("\r\n");
  }
  if (counts[33]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_quantize_16x3072 calls="); nr_hex64(counts[33]);
    nr_puts(" cycles="); nr_hex64(cycles[33]);
    nr_puts("\r\n");
  }
  if (counts[34]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_quantize_1x1024 calls="); nr_hex64(counts[34]);
    nr_puts(" cycles="); nr_hex64(cycles[34]);
    nr_puts("\r\n");
  }
  if (counts[35]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_quantize_1x2048 calls="); nr_hex64(counts[35]);
    nr_puts(" cycles="); nr_hex64(cycles[35]);
    nr_puts("\r\n");
  }
  if (counts[36]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_quantize_1x3072 calls="); nr_hex64(counts[36]);
    nr_puts(" cycles="); nr_hex64(cycles[36]);
    nr_puts("\r\n");
  }
  if (counts[37]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_rmsnorm_128x128 calls="); nr_hex64(counts[37]);
    nr_puts(" cycles="); nr_hex64(cycles[37]);
    nr_puts("\r\n");
  }
  if (counts[38]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_rmsnorm_16x1024 calls="); nr_hex64(counts[38]);
    nr_puts(" cycles="); nr_hex64(cycles[38]);
    nr_puts("\r\n");
  }
  if (counts[39]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_rmsnorm_16x128 calls="); nr_hex64(counts[39]);
    nr_puts(" cycles="); nr_hex64(cycles[39]);
    nr_puts("\r\n");
  }
  if (counts[40]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_rmsnorm_1x1024 calls="); nr_hex64(counts[40]);
    nr_puts(" cycles="); nr_hex64(cycles[40]);
    nr_puts("\r\n");
  }
  if (counts[41]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_rmsnorm_256x128 calls="); nr_hex64(counts[41]);
    nr_puts(" cycles="); nr_hex64(cycles[41]);
    nr_puts("\r\n");
  }
  if (counts[42]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_rmsnorm_8x128 calls="); nr_hex64(counts[42]);
    nr_puts(" cycles="); nr_hex64(cycles[42]);
    nr_puts("\r\n");
  }
  if (counts[43]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_silu_16x3072 calls="); nr_hex64(counts[43]);
    nr_puts(" cycles="); nr_hex64(cycles[43]);
    nr_puts("\r\n");
  }
  if (counts[44]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_silu_1x3072 calls="); nr_hex64(counts[44]);
    nr_puts(" cycles="); nr_hex64(cycles[44]);
    nr_puts("\r\n");
  }
  if (counts[45]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_softmax_16x16x512 calls="); nr_hex64(counts[45]);
    nr_puts(" cycles="); nr_hex64(cycles[45]);
    nr_puts("\r\n");
  }
  if (counts[46]) {
    nr_puts("[profile] position="); nr_hex32(position);
    nr_puts(" kernel=_mlir_ciface_kernel_softmax_16x1x512 calls="); nr_hex64(counts[46]);
    nr_puts(" cycles="); nr_hex64(cycles[46]);
    nr_puts("\r\n");
  }
}
...
extern void __real__mlir_ciface_kernel_attention_qk_position_16x16x512x128(MemRef3 *a0, MemRef3 *a1, MemRef1 *a2, MemRef3 *a3);
void __wrap__mlir_ciface_kernel_attention_qk_position_16x16x512x128(MemRef3 *a0, MemRef3 *a1, MemRef1 *a2, MemRef3 *a3) {
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_attention_qk_position_16x16x512x128(a0, a1, a2, a3);
  ame_fence();
  cycles[2] += nr_cycles()-begin; ++counts[2];
}
extern void __real__mlir_ciface_kernel_attention_qk_position_16x1x512x128(MemRef3 *a0, MemRef3 *a1, MemRef1 *a2, MemRef3 *a3);
void __wrap__mlir_ciface_kernel_attention_qk_position_16x1x512x128(MemRef3 *a0, MemRef3 *a1, MemRef1 *a2, MemRef3 *a3) {
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_attention_qk_position_16x1x512x128(a0, a1, a2, a3);
  ame_fence();
...
extern void __real__mlir_ciface_kernel_layout_k_16x512x128(MemRef3 *a0, MemRef3 *a1);
void __wrap__mlir_ciface_kernel_layout_k_16x512x128(MemRef3 *a0, MemRef3 *a1) {
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_layout_k_16x512x128(a0, a1);
  ame_fence();
...
void __wrap__mlir_ciface_kernel_softmax_16x1x512(MemRef3 *a0, MemRef1 *a1, MemRef1 *a2, MemRef3 *a3) {
  ...
  ame_fence();
  cycles[46] += nr_cycles()-begin; ++counts[46];
}
