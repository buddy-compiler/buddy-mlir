...
void __wrap__mlir_ciface_kernel_attention_pv_position_16x16x128x512(MemRef3 *a0, MemRef3 *a1, MemRef1 *a2, MemRef3 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_attention_pv_position_16x16x128x512 call="); nr_hex64(counts[0]);
  nr_puts("\r\n");
  ...
  nr_puts("[kernel] end _mlir_ciface_kernel_attention_pv_position_16x16x128x512 call="); nr_hex64(counts[0]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_attention_pv_position_16x1x128x512(MemRef3 *a0, MemRef3 *a1, MemRef1 *a2, MemRef3 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_attention_pv_position_16x1x128x512 call="); nr_hex64(counts[1]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_attention_pv_position_16x1x128x512(a0, a1, a2, a3);
  ame_fence();
  cycles[1] += nr_cycles()-begin; ++counts[1];
  nr_puts("[kernel] end _mlir_ciface_kernel_attention_pv_position_16x1x128x512 call="); nr_hex64(counts[1]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_attention_qk_position_native_16x16x512x128(MemRef3 *a0, MemRef3 *a1, MemRef1 *a2, MemRef3 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_attention_qk_position_native_16x16x512x128 call="); nr_hex64(counts[2]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_attention_qk_position_native_16x16x512x128(a0, a1, a2, a3);
  ame_fence();
  cycles[2] += nr_cycles()-begin; ++counts[2];
  nr_puts("[kernel] end _mlir_ciface_kernel_attention_qk_position_native_16x16x512x128 call="); nr_hex64(counts[2]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_attention_qk_position_native_16x1x512x128(MemRef3 *a0, MemRef3 *a1, MemRef1 *a2, MemRef3 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_attention_qk_position_native_16x1x512x128 call="); nr_hex64(counts[3]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_attention_qk_position_native_16x1x512x128(a0, a1, a2, a3);
  ame_fence();
  cycles[3] += nr_cycles()-begin; ++counts[3];
  nr_puts("[kernel] end _mlir_ciface_kernel_attention_qk_position_native_16x1x512x128 call="); nr_hex64(counts[3]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_attention_scale_mask_position_16x16x512(MemRef3 *a0, MemRef1 *a1, MemRef3 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_attention_scale_mask_position_16x16x512 call="); nr_hex64(counts[4]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_attention_scale_mask_position_16x16x512(a0, a1, a2);
  ame_fence();
  cycles[4] += nr_cycles()-begin; ++counts[4];
  nr_puts("[kernel] end _mlir_ciface_kernel_attention_scale_mask_position_16x16x512 call="); nr_hex64(counts[4]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_attention_scale_mask_position_16x1x512(MemRef3 *a0, MemRef1 *a1, MemRef3 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_attention_scale_mask_position_16x1x512 call="); nr_hex64(counts[5]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_attention_scale_mask_position_16x1x512(a0, a1, a2);
  ame_fence();
  cycles[5] += nr_cycles()-begin; ++counts[5];
  nr_puts("[kernel] end _mlir_ciface_kernel_attention_scale_mask_position_16x1x512 call="); nr_hex64(counts[5]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_dequantize_16x1024(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_dequantize_16x1024 call="); nr_hex64(counts[6]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_dequantize_16x1024(a0, a1, a2, a3);
  ame_fence();
  cycles[6] += nr_cycles()-begin; ++counts[6];
  nr_puts("[kernel] end _mlir_ciface_kernel_dequantize_16x1024 call="); nr_hex64(counts[6]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_dequantize_16x2048(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_dequantize_16x2048 call="); nr_hex64(counts[7]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_dequantize_16x2048(a0, a1, a2, a3);
  ame_fence();
  cycles[7] += nr_cycles()-begin; ++counts[7];
  nr_puts("[kernel] end _mlir_ciface_kernel_dequantize_16x2048 call="); nr_hex64(counts[7]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_dequantize_16x3072(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_dequantize_16x3072 call="); nr_hex64(counts[8]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_dequantize_16x3072(a0, a1, a2, a3);
  ame_fence();
  cycles[8] += nr_cycles()-begin; ++counts[8];
  nr_puts("[kernel] end _mlir_ciface_kernel_dequantize_16x3072 call="); nr_hex64(counts[8]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_dequantize_1x1024(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_dequantize_1x1024 call="); nr_hex64(counts[9]);
  nr_puts("\r\n");
  const int probe_selected = counts[9] == 12ULL;
  if (probe_selected) {
    nr_puts("[probe] descriptor _mlir_ciface_kernel_dequantize_1x1024 call="); nr_hex64(counts[9]);
    nr_puts(" arg="); nr_hex32(0);
    nr_puts(" descriptor="); nr_hex64((uintptr_t)a0);
    if (a0) {
      nr_puts(" aligned="); nr_hex64((uintptr_t)a0->aligned);
      nr_puts(" offset="); nr_hex64((uint64_t)a0->offset);
      nr_puts(" rank="); nr_hex32(2);
      nr_puts(" size0="); nr_hex64((uint64_t)a0->sizes[0]);
      nr_puts(" stride0="); nr_hex64((uint64_t)a0->strides[0]);
      nr_puts(" size1="); nr_hex64((uint64_t)a0->sizes[1]);
      nr_puts(" stride1="); nr_hex64((uint64_t)a0->strides[1]);
    } else nr_puts(" null_descriptor");
    nr_puts("\r\n");
    nr_puts("[probe] descriptor _mlir_ciface_kernel_dequantize_1x1024 call="); nr_hex64(counts[9]);
    nr_puts(" arg="); nr_hex32(1);
    nr_puts(" descriptor="); nr_hex64((uintptr_t)a1);
    if (a1) {
      nr_puts(" aligned="); nr_hex64((uintptr_t)a1->aligned);
      nr_puts(" offset="); nr_hex64((uint64_t)a1->offset);
      nr_puts(" rank="); nr_hex32(1);
      nr_puts(" size0="); nr_hex64((uint64_t)a1->sizes[0]);
      nr_puts(" stride0="); nr_hex64((uint64_t)a1->strides[0]);
    } else nr_puts(" null_descriptor");
    nr_puts("\r\n");
    nr_puts("[probe] descriptor _mlir_ciface_kernel_dequantize_1x1024 call="); nr_hex64(counts[9]);
    nr_puts(" arg="); nr_hex32(2);
    nr_puts(" descriptor="); nr_hex64((uintptr_t)a2);
    if (a2) {
      nr_puts(" aligned="); nr_hex64((uintptr_t)a2->aligned);
      nr_puts(" offset="); nr_hex64((uint64_t)a2->offset);
      nr_puts(" rank="); nr_hex32(1);
      nr_puts(" size0="); nr_hex64((uint64_t)a2->sizes[0]);
      nr_puts(" stride0="); nr_hex64((uint64_t)a2->strides[0]);
    } else nr_puts(" null_descriptor");
    nr_puts("\r\n");
    nr_puts("[probe] descriptor _mlir_ciface_kernel_dequantize_1x1024 call="); nr_hex64(counts[9]);
    nr_puts(" arg="); nr_hex32(3);
    nr_puts(" descriptor="); nr_hex64((uintptr_t)a3);
    if (a3) {
      nr_puts(" aligned="); nr_hex64((uintptr_t)a3->aligned);
      nr_puts(" offset="); nr_hex64((uint64_t)a3->offset);
      nr_puts(" rank="); nr_hex32(2);
      nr_puts(" size0="); nr_hex64((uint64_t)a3->sizes[0]);
      nr_puts(" stride0="); nr_hex64((uint64_t)a3->strides[0]);
      nr_puts(" size1="); nr_hex64((uint64_t)a3->sizes[1]);
      nr_puts(" stride1="); nr_hex64((uint64_t)a3->strides[1]);
    } else nr_puts(" null_descriptor");
    nr_puts("\r\n");
  }
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_dequantize_1x1024(a0, a1, a2, a3);
  if (probe_selected) { nr_puts("[probe] returned _mlir_ciface_kernel_dequantize_1x1024 call=");
    nr_hex64(counts[9]); nr_puts("\r\n"); }
  ame_fence();
  if (probe_selected) { nr_puts("[probe] synced _mlir_ciface_kernel_dequantize_1x1024 call=");
    nr_hex64(counts[9]); nr_puts("\r\n"); }
  cycles[9] += nr_cycles()-begin; ++counts[9];
  nr_puts("[kernel] end _mlir_ciface_kernel_dequantize_1x1024 call="); nr_hex64(counts[9]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_dequantize_1x151936(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_dequantize_1x151936 call="); nr_hex64(counts[10]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_dequantize_1x151936(a0, a1, a2, a3);
  ame_fence();
  cycles[10] += nr_cycles()-begin; ++counts[10];
  nr_puts("[kernel] end _mlir_ciface_kernel_dequantize_1x151936 call="); nr_hex64(counts[10]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_dequantize_1x2048(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_dequantize_1x2048 call="); nr_hex64(counts[11]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_dequantize_1x2048(a0, a1, a2, a3);
  ame_fence();
  cycles[11] += nr_cycles()-begin; ++counts[11];
  nr_puts("[kernel] end _mlir_ciface_kernel_dequantize_1x2048 call="); nr_hex64(counts[11]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_dequantize_1x3072(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_dequantize_1x3072 call="); nr_hex64(counts[12]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_dequantize_1x3072(a0, a1, a2, a3);
  ame_fence();
  cycles[12] += nr_cycles()-begin; ++counts[12];
  nr_puts("[kernel] end _mlir_ciface_kernel_dequantize_1x3072 call="); nr_hex64(counts[12]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_embedding_w8a8_16x1024(MemRef1 *a0, MemRef2 *a1, MemRef2 *a2, MemRef1 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_embedding_w8a8_16x1024 call="); nr_hex64(counts[13]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_embedding_w8a8_16x1024(a0, a1, a2, a3);
  ame_fence();
  cycles[13] += nr_cycles()-begin; ++counts[13];
  nr_puts("[kernel] end _mlir_ciface_kernel_embedding_w8a8_16x1024 call="); nr_hex64(counts[13]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_embedding_w8a8_1x1024(MemRef1 *a0, MemRef2 *a1, MemRef2 *a2, MemRef1 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_embedding_w8a8_1x1024 call="); nr_hex64(counts[14]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_embedding_w8a8_1x1024(a0, a1, a2, a3);
  ame_fence();
  cycles[14] += nr_cycles()-begin; ++counts[14];
  nr_puts("[kernel] end _mlir_ciface_kernel_embedding_w8a8_1x1024 call="); nr_hex64(counts[14]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_kv_cache_update_position_16x8x128_cap512(MemRef3 *a0, MemRef1 *a1, MemRef3 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_kv_cache_update_position_16x8x128_cap512 call="); nr_hex64(counts[15]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_kv_cache_update_position_16x8x128_cap512(a0, a1, a2);
  ame_fence();
  cycles[15] += nr_cycles()-begin; ++counts[15];
  nr_puts("[kernel] end _mlir_ciface_kernel_kv_cache_update_position_16x8x128_cap512 call="); nr_hex64(counts[15]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_kv_cache_update_position_1x8x128_cap512(MemRef3 *a0, MemRef1 *a1, MemRef3 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_kv_cache_update_position_1x8x128_cap512 call="); nr_hex64(counts[16]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_kv_cache_update_position_1x8x128_cap512(a0, a1, a2);
  ame_fence();
  cycles[16] += nr_cycles()-begin; ++counts[16];
  nr_puts("[kernel] end _mlir_ciface_kernel_kv_cache_update_position_1x8x128_cap512 call="); nr_hex64(counts[16]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_layout_context_8x16x128(MemRef3 *a0, MemRef3 *a1) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_layout_context_8x16x128 call="); nr_hex64(counts[17]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_layout_context_8x16x128(a0, a1);
  ame_fence();
  cycles[17] += nr_cycles()-begin; ++counts[17];
  nr_puts("[kernel] end _mlir_ciface_kernel_layout_context_8x16x128 call="); nr_hex64(counts[17]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_layout_context_8x1x128(MemRef3 *a0, MemRef3 *a1) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_layout_context_8x1x128 call="); nr_hex64(counts[18]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_layout_context_8x1x128(a0, a1);
  ame_fence();
  cycles[18] += nr_cycles()-begin; ++counts[18];
  nr_puts("[kernel] end _mlir_ciface_kernel_layout_context_8x1x128 call="); nr_hex64(counts[18]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_16x1024x1024(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_16x1024x1024 call="); nr_hex64(counts[19]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_16x1024x1024(a0, a1, a2);
  ame_fence();
  cycles[19] += nr_cycles()-begin; ++counts[19];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_16x1024x1024 call="); nr_hex64(counts[19]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_16x1024x2048(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_16x1024x2048 call="); nr_hex64(counts[20]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_16x1024x2048(a0, a1, a2);
  ame_fence();
  cycles[20] += nr_cycles()-begin; ++counts[20];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_16x1024x2048 call="); nr_hex64(counts[20]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_16x1024x3072(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_16x1024x3072 call="); nr_hex64(counts[21]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_16x1024x3072(a0, a1, a2);
  ame_fence();
  cycles[21] += nr_cycles()-begin; ++counts[21];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_16x1024x3072 call="); nr_hex64(counts[21]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_16x2048x1024(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_16x2048x1024 call="); nr_hex64(counts[22]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_16x2048x1024(a0, a1, a2);
  ame_fence();
  cycles[22] += nr_cycles()-begin; ++counts[22];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_16x2048x1024 call="); nr_hex64(counts[22]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_16x3072x1024(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_16x3072x1024 call="); nr_hex64(counts[23]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_16x3072x1024(a0, a1, a2);
  ame_fence();
  cycles[23] += nr_cycles()-begin; ++counts[23];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_16x3072x1024 call="); nr_hex64(counts[23]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_1x1024x1024(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_1x1024x1024 call="); nr_hex64(counts[24]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_1x1024x1024(a0, a1, a2);
  ame_fence();
  cycles[24] += nr_cycles()-begin; ++counts[24];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_1x1024x1024 call="); nr_hex64(counts[24]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_1x1024x2048(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_1x1024x2048 call="); nr_hex64(counts[25]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_1x1024x2048(a0, a1, a2);
  ame_fence();
  cycles[25] += nr_cycles()-begin; ++counts[25];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_1x1024x2048 call="); nr_hex64(counts[25]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_1x1024x3072(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_1x1024x3072 call="); nr_hex64(counts[26]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_1x1024x3072(a0, a1, a2);
  ame_fence();
  cycles[26] += nr_cycles()-begin; ++counts[26];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_1x1024x3072 call="); nr_hex64(counts[26]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_1x151936x1024(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_1x151936x1024 call="); nr_hex64(counts[27]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_1x151936x1024(a0, a1, a2);
  ame_fence();
  cycles[27] += nr_cycles()-begin; ++counts[27];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_1x151936x1024 call="); nr_hex64(counts[27]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_1x2048x1024(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_1x2048x1024 call="); nr_hex64(counts[28]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_1x2048x1024(a0, a1, a2);
  ame_fence();
  cycles[28] += nr_cycles()-begin; ++counts[28];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_1x2048x1024 call="); nr_hex64(counts[28]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_matmul_1x3072x1024(MemRef2 *a0, MemRef2 *a1, MemRef2 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_matmul_1x3072x1024 call="); nr_hex64(counts[29]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_matmul_1x3072x1024(a0, a1, a2);
  ame_fence();
  cycles[29] += nr_cycles()-begin; ++counts[29];
  nr_puts("[kernel] end _mlir_ciface_kernel_matmul_1x3072x1024 call="); nr_hex64(counts[29]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_quantize_16x1024(MemRef2 *a0, MemRef2 *a1, MemRef1 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_quantize_16x1024 call="); nr_hex64(counts[30]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_quantize_16x1024(a0, a1, a2);
  ame_fence();
  cycles[30] += nr_cycles()-begin; ++counts[30];
  nr_puts("[kernel] end _mlir_ciface_kernel_quantize_16x1024 call="); nr_hex64(counts[30]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_quantize_16x2048(MemRef2 *a0, MemRef2 *a1, MemRef1 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_quantize_16x2048 call="); nr_hex64(counts[31]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_quantize_16x2048(a0, a1, a2);
  ame_fence();
  cycles[31] += nr_cycles()-begin; ++counts[31];
  nr_puts("[kernel] end _mlir_ciface_kernel_quantize_16x2048 call="); nr_hex64(counts[31]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_quantize_16x3072(MemRef2 *a0, MemRef2 *a1, MemRef1 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_quantize_16x3072 call="); nr_hex64(counts[32]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_quantize_16x3072(a0, a1, a2);
  ame_fence();
  cycles[32] += nr_cycles()-begin; ++counts[32];
  nr_puts("[kernel] end _mlir_ciface_kernel_quantize_16x3072 call="); nr_hex64(counts[32]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_quantize_1x1024(MemRef2 *a0, MemRef2 *a1, MemRef1 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_quantize_1x1024 call="); nr_hex64(counts[33]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_quantize_1x1024(a0, a1, a2);
  ame_fence();
  cycles[33] += nr_cycles()-begin; ++counts[33];
  nr_puts("[kernel] end _mlir_ciface_kernel_quantize_1x1024 call="); nr_hex64(counts[33]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_quantize_1x2048(MemRef2 *a0, MemRef2 *a1, MemRef1 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_quantize_1x2048 call="); nr_hex64(counts[34]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_quantize_1x2048(a0, a1, a2);
  ame_fence();
  cycles[34] += nr_cycles()-begin; ++counts[34];
  nr_puts("[kernel] end _mlir_ciface_kernel_quantize_1x2048 call="); nr_hex64(counts[34]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_quantize_1x3072(MemRef2 *a0, MemRef2 *a1, MemRef1 *a2) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_quantize_1x3072 call="); nr_hex64(counts[35]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_quantize_1x3072(a0, a1, a2);
  ame_fence();
  cycles[35] += nr_cycles()-begin; ++counts[35];
  nr_puts("[kernel] end _mlir_ciface_kernel_quantize_1x3072 call="); nr_hex64(counts[35]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_rmsnorm_128x128(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_rmsnorm_128x128 call="); nr_hex64(counts[36]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_rmsnorm_128x128(a0, a1, a2, a3);
  ame_fence();
  cycles[36] += nr_cycles()-begin; ++counts[36];
  nr_puts("[kernel] end _mlir_ciface_kernel_rmsnorm_128x128 call="); nr_hex64(counts[36]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_rmsnorm_16x1024(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_rmsnorm_16x1024 call="); nr_hex64(counts[37]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_rmsnorm_16x1024(a0, a1, a2, a3);
  ame_fence();
  cycles[37] += nr_cycles()-begin; ++counts[37];
  nr_puts("[kernel] end _mlir_ciface_kernel_rmsnorm_16x1024 call="); nr_hex64(counts[37]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_rmsnorm_16x128(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_rmsnorm_16x128 call="); nr_hex64(counts[38]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_rmsnorm_16x128(a0, a1, a2, a3);
  ame_fence();
  cycles[38] += nr_cycles()-begin; ++counts[38];
  nr_puts("[kernel] end _mlir_ciface_kernel_rmsnorm_16x128 call="); nr_hex64(counts[38]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_rmsnorm_1x1024(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_rmsnorm_1x1024 call="); nr_hex64(counts[39]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_rmsnorm_1x1024(a0, a1, a2, a3);
  ame_fence();
  cycles[39] += nr_cycles()-begin; ++counts[39];
  nr_puts("[kernel] end _mlir_ciface_kernel_rmsnorm_1x1024 call="); nr_hex64(counts[39]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_rmsnorm_256x128(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_rmsnorm_256x128 call="); nr_hex64(counts[40]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_rmsnorm_256x128(a0, a1, a2, a3);
  ame_fence();
  cycles[40] += nr_cycles()-begin; ++counts[40];
  nr_puts("[kernel] end _mlir_ciface_kernel_rmsnorm_256x128 call="); nr_hex64(counts[40]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_rmsnorm_8x128(MemRef2 *a0, MemRef1 *a1, MemRef1 *a2, MemRef2 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_rmsnorm_8x128 call="); nr_hex64(counts[41]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_rmsnorm_8x128(a0, a1, a2, a3);
  ame_fence();
  cycles[41] += nr_cycles()-begin; ++counts[41];
  nr_puts("[kernel] end _mlir_ciface_kernel_rmsnorm_8x128 call="); nr_hex64(counts[41]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_silu_16x3072(MemRef2 *a0, MemRef2 *a1) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_silu_16x3072 call="); nr_hex64(counts[42]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_silu_16x3072(a0, a1);
  ame_fence();
  cycles[42] += nr_cycles()-begin; ++counts[42];
  nr_puts("[kernel] end _mlir_ciface_kernel_silu_16x3072 call="); nr_hex64(counts[42]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_silu_1x3072(MemRef2 *a0, MemRef2 *a1) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_silu_1x3072 call="); nr_hex64(counts[43]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_silu_1x3072(a0, a1);
  ame_fence();
  cycles[43] += nr_cycles()-begin; ++counts[43];
  nr_puts("[kernel] end _mlir_ciface_kernel_silu_1x3072 call="); nr_hex64(counts[43]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_softmax_16x16x512(MemRef3 *a0, MemRef1 *a1, MemRef1 *a2, MemRef3 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_softmax_16x16x512 call="); nr_hex64(counts[44]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_softmax_16x16x512(a0, a1, a2, a3);
  ame_fence();
  cycles[44] += nr_cycles()-begin; ++counts[44];
  nr_puts("[kernel] end _mlir_ciface_kernel_softmax_16x16x512 call="); nr_hex64(counts[44]-1);
  nr_puts("\r\n");
}
...
void __wrap__mlir_ciface_kernel_softmax_16x1x512(MemRef3 *a0, MemRef1 *a1, MemRef1 *a2, MemRef3 *a3) {
  nr_puts("[kernel] begin _mlir_ciface_kernel_softmax_16x1x512 call="); nr_hex64(counts[45]);
  nr_puts("\r\n");
  uint64_t begin=nr_cycles();
  __real__mlir_ciface_kernel_softmax_16x1x512(a0, a1, a2, a3);
  ame_fence();
  cycles[45] += nr_cycles()-begin; ++counts[45];
  nr_puts("[kernel] end _mlir_ciface_kernel_softmax_16x1x512 call="); nr_hex64(counts[45]-1);
  nr_puts("\r\n");
}
