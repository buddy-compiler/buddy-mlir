...
/home/chh/miniconda3/envs/boscame/bin/python -B "$MODEL/tools/build_nr_w8a8_image.py" \
  --repo-root "$PWD" \
  ...
  --archive "$MODEL/build/ame-v05/model-dequant-lib/libqwen_triton.a" \
  --adapters "$STAGE/replacement/qwen_triton_adapters.c" \
  --output "$MODEL/build/ame-v05/model-dequant-image" \
...
/home/chh/miniconda3/envs/boscame/bin/python -B "$MODEL/tools/prepare_model_run.py" \
  --image "$MODEL/build/ame-v05/model-dequant-image/qwen_model.bin" \
  --elf "$MODEL/build/ame-v05/model-dequant-image/qwen_model.elf" \
  ...
  --output "$MODEL/build/ame-v05/model-dequant-prepared"
