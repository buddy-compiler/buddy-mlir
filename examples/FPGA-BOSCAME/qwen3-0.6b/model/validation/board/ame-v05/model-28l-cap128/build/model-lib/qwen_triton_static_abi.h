...
void _mlir_ciface_kernel_attention_pv_position_16x16x128x128(QwenMemRef3 *, QwenMemRef3 *, QwenMemRef1 *, QwenMemRef3 *);
void _mlir_ciface_kernel_attention_pv_position_16x1x128x128(QwenMemRef3 *, QwenMemRef3 *, QwenMemRef1 *, QwenMemRef3 *);
void _mlir_ciface_kernel_attention_qk_position_native_16x16x128x128(QwenMemRef3 *, QwenMemRef3 *, QwenMemRef1 *, QwenMemRef3 *);
void _mlir_ciface_kernel_attention_qk_position_native_16x1x128x128(QwenMemRef3 *, QwenMemRef3 *, QwenMemRef1 *, QwenMemRef3 *);
void _mlir_ciface_kernel_attention_scale_mask_position_16x16x128(QwenMemRef3 *, QwenMemRef1 *, QwenMemRef3 *);
void _mlir_ciface_kernel_attention_scale_mask_position_16x1x128(QwenMemRef3 *, QwenMemRef1 *, QwenMemRef3 *);
...
void _mlir_ciface_kernel_kv_cache_update_position_16x8x128_cap128(QwenMemRef3 *, QwenMemRef1 *, QwenMemRef3 *);
void _mlir_ciface_kernel_kv_cache_update_position_1x8x128_cap128(QwenMemRef3 *, QwenMemRef1 *, QwenMemRef3 *);
...
void _mlir_ciface_kernel_softmax_16x16x128(QwenMemRef3 *, QwenMemRef1 *, QwenMemRef1 *, QwenMemRef3 *);
void _mlir_ciface_kernel_softmax_16x1x128(QwenMemRef3 *, QwenMemRef1 *, QwenMemRef1 *, QwenMemRef3 *);
#ifdef __cplusplus
}
#endif
#endif
