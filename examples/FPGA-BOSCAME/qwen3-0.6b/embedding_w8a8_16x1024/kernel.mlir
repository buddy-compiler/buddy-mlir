...
module {
  func.func @kernel_embedding_w8a8_16x1024(%ids: memref<16xi64>, %out: memref<16x1024xf32>, %weight: memref<151936x1024xi8>, %scale: memref<151936xf32>) attributes {llvm.emit_c_interface} {
