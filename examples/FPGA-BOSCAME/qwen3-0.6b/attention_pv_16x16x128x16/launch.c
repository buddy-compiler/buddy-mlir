...
#define N 128
#define K 16
extern void _mlir_ciface_kernel_attention_pv_16x16x128x16(MemRef3*,MemRef3*,MemRef3*);
int launch(void) {
  ...
  _mlir_ciface_kernel_attention_pv_16x16x128x16(&A,&B,&C);
  ...
  return print_check("attention_pv_16x16x128x16",errors,max_error);
}
