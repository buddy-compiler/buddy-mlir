...
//
// This file tests lowering a linalg.generic column broadcast pattern to BOSCAME.

#identity_2d = affine_map<(d0, d1) -> (d0, d1)>
#broadcast_col = affine_map<(d0, d1) -> (d0)>

module {
  func.func private @print_C(i32, i32, i32, i32)

  func.func @generic_broadcast_column_i32_4x4(%V: memref<4xi32>,
                                              %C: memref<4x4xi32>) {
    linalg.generic {
      indexing_maps = [#broadcast_col, #identity_2d],
  ...
  func.func @main() -> i32 {
    ...
    memref.store %c1_i32, %V[%i0] : memref<4xi32>
    memref.store %c2_i32, %V[%i1] : memref<4xi32>
    memref.store %c3_i32, %V[%i2] : memref<4xi32>
    memref.store %c4_i32, %V[%i3] : memref<4xi32>

    call @generic_broadcast_column_i32_4x4(%V, %C)
      : (memref<4xi32>, memref<4x4xi32>) -> ()
...
// CHECK-LABEL: func.func @generic_broadcast_column_i32_4x4
// CHECK-SAME: (%[[V:.*]]: memref<4xi32>, %[[C:.*]]: memref<4x4xi32>)
// CHECK: scf.for
// CHECK:   scf.for
// CHECK:     %[[SUBVIEW_V:.*]] = memref.subview %[[V]]
// CHECK:     %[[SUBVIEW_C:.*]] = memref.subview %[[C]]
// CHECK:     bosc_ame.mlce32.m 0, %[[SUBVIEW_V]]
// CHECK:     bosc_ame.mbccce32.m 1, 0
