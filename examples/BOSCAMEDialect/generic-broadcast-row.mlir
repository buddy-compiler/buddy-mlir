...
//
// This file tests lowering a linalg.generic row broadcast pattern to BOSCAME.

#identity_2d = affine_map<(d0, d1) -> (d0, d1)>
#broadcast_row = affine_map<(d0, d1) -> (d1)>

module {
  func.func private @print_C(i32, i32, i32, i32)

  func.func @generic_broadcast_row_i32_4x4(%V: memref<4xi32>,
                                           %C: memref<4x4xi32>) {
    linalg.generic {
      indexing_maps = [#broadcast_row, #identity_2d],
  ...
  func.func @main() -> i32 {
    ...
    call @generic_broadcast_row_i32_4x4(%V, %C)
...
// CHECK-LABEL: func.func @generic_broadcast_row_i32_4x4
