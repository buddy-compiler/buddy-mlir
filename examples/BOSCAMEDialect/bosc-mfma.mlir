...
//
// ===========================================================================
// Complete Matrix Multiplication Demo using RISC-V Matrix Extension (BOSC MFMA)
// ===========================================================================
//
...
// 5. Load matrix tiles (mlae32.m, mlbe32.m)
// 6. Execute matrix multiply (mfma.f.mm)
...
module {
  ...
  func.func @main() -> i32 {
    ...
    %acc = bosc_ame.mfma.f.mm %md, %lhs, %rhs : vector<4x4xf32>, vector<4x4xf32>, vector<4x4xf32> -> vector<4x4xf32>
