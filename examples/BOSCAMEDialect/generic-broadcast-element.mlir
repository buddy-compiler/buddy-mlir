...
#broadcast_elem = affine_map<(d0, d1) -> ()>

module {
  func.func private @print_C(i32, i32, i32, i32)

  func.func @generic_broadcast_element_i32_4x4(%S: memref<i32>,
                                               %C: memref<4x4xi32>) {
    linalg.generic {
      indexing_maps = [#broadcast_elem, #identity_2d],
  ...
  func.func @main() -> i32 {
    ...
    memref.store %c7_i32, %S[] : memref<i32>

    call @generic_broadcast_element_i32_4x4(%S, %C)
      : (memref<i32>, memref<4x4xi32>) -> ()
