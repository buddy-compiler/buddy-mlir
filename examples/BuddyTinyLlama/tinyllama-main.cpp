...
/// Declare TinyLLaMA forward function.
extern "C" void _mlir_ciface_forward(MemRef<float, 3> *,
                                     MemRef<bp16_t, 1> *,Text<size_t, 2> *);
...
// -----------------------------------------------------------------------------
// TinyLLaMA Inference Main Entry
// -----------------------------------------------------------------------------

int main() {
  /// Print the title of this example.
  const std::string title = "TinyLLaMA Inference Powered by Buddy Compiler";
  std::cout << "\033[33;1m" << title << "\033[0m" << std::endl;

  /// Define directories of vacabulary and parameter file.
  const std::string vocabDir = "../../examples/BuddyTinyLlama/vocab.txt";
  const std::string paramsDir = "../../examples/BuddyTinyLlama/arg0.data";
  ...
  MemRef<bp16_t, 1> paramsContainerbf16({ParamsSize});
  ...
  for (size_t j = 0; j < ParamsSize; j++) {
     paramsContainerbf16[j] = float2bfloat(paramsContainerf32[j]);
  }
  ...
  for (int i = 0; i < generateLen; i++) {
    ...
    _mlir_ciface_forward(resultContainer, &paramsContainerbf16, &inputContainer);
