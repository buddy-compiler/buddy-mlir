...
// Declare CodeT5 forward function.
extern "C" void
...
int main() {
  ...
  const std::string title = "CodeT5 Inference Powered by Buddy Compiler";
  std::cout << "\033[33;1m" << title << "\033[0m" << std::endl;
  
  /// Load weights to MemRef container.
  MemRef<float, 1> arg0({109486854});
  MemRef<long long, 1> arg1({512});
  loadParameters("../../examples/BuddyCodeT5/arg0.data",
                 "../../examples/BuddyCodeT5/arg1.data", arg0, arg1);

  /// Get user message and build Text container.
  std::cout << "What program do you want to run with CodeT5?" << std::endl;
  std::cout << ">>> ";
  std::string pureStr;
  ...
  std::string vocabDir = "../../examples/BuddyCodeT5/vocab.txt";
  pureStrContainer.tokenizeCodeT5(vocabDir, 5);
