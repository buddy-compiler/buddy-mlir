...
parser.add_argument(
    "--enable-qkv-fusion",
    action="store_true",
    help="Enable QKV fusion optimization for prefill graph (experimental).",
)
