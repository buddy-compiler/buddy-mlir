...
func.func @main() -> i32 {
  ...
  //===--------------------------------------------------------------------===//
  // VP Intrinsic FDiv Operation + Scalable Vector Type
  //===--------------------------------------------------------------------===//

  // Mask-Driven
  %res_fdiv_mask_driven = "llvm.intr.vp.fdiv" (%load_vec2_f32, %load_vec1_f32, %mask_scalable6, %vl8_i32) :
      (vector<[4]xf32>, vector<[4]xf32>, vector<[4]xi1>, i32) -> vector<[4]xf32>
  call @print_scalable_vector_f32(%res_fdiv_mask_driven) : (vector<[4]xf32>) -> ()

  // EVL-Driven
  %res_fdiv_evl_driven = "llvm.intr.vp.fdiv" (%load_vec2_f32, %load_vec1_f32, %mask_scalable8, %vl6_i32) :
      (vector<[4]xf32>, vector<[4]xf32>, vector<[4]xi1>, i32) -> vector<[4]xf32>
  call @print_scalable_vector_f32(%res_fdiv_mask_driven) : (vector<[4]xf32>) -> ()

  //===--------------------------------------------------------------------===//
  // VP Intrinsic SDiv Operation + Scalable Vector Type
  //===--------------------------------------------------------------------===//

  // Mask-Driven
  %res_sdiv_mask_driven = "llvm.intr.vp.sdiv" (%load_vec2_i32, %load_vec1_i32, %mask_scalable6, %vl8_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_sdiv_mask_driven) : (vector<[4]xi32>) -> ()


  // EVL-Driven
  %res_sdiv_evl_driven = "llvm.intr.vp.sdiv" (%load_vec2_i32, %load_vec1_i32, %mask_scalable8, %vl6_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_sdiv_evl_driven) : (vector<[4]xi32>) -> ()

  //===--------------------------------------------------------------------===//
  // VP Intrinsic UDiv Operation + Scalable Vector Type
  //===--------------------------------------------------------------------===//
  ...
  %res_udiv_evl_driven = "llvm.intr.vp.udiv" (%load_vec2_i32, %load_vec1_i32, %mask_scalable8, %vl6_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_udiv_evl_driven) : (vector<[4]xi32>) -> ()
