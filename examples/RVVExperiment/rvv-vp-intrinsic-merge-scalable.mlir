...
func.func @main() -> i32 {
  ...
  // Mask-Driven
  %res_mask_driven = "llvm.intr.vp.merge" (%mask_scalable6, %load_vec2, %load_vec1, %vl8_i32) :
      (vector<[4]xi1>, vector<[4]xi32>, vector<[4]xi32>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_mask_driven) : (vector<[4]xi32>) -> ()

  // EVL-Driven
  %res_evl_driven = "llvm.intr.vp.merge" (%mask_scalable8, %load_vec2, %load_vec1, %vl6_i32) :
      (vector<[4]xi1>, vector<[4]xi32>, vector<[4]xi32>, i32) -> vector<[4]xi32>
...
func.func @print_scalable_vector_i32(%vec : vector<[4]xi32>) {
  ...
  %res_mem = call @alloc_mem() : () -> memref<20xi32>
