...
func.func @main() -> i32 {
  ...
  //===--------------------------------------------------------------------===//
  // VP Intrinsic FRem Operation + Scalable Vector Type
  //===--------------------------------------------------------------------===//

  // // Mask-Driven Error
  // %res_frem_mask_driven = "llvm.intr.vp.frem" (%load_vec2_f32, %load_vec1_f32, %mask_scalable6, %vl8_i32) :
  //     (vector<[4]xf32>, vector<[4]xf32>, vector<[4]xi1>, i32) -> vector<[4]xf32>
  // call @print_scalable_vector_f32(%res_frem_mask_driven) : (vector<[4]xf32>) -> ()

  // // EVL-Driven Error
  // %res_frem_evl_driven = "llvm.intr.vp.frem" (%load_vec2_f32, %load_vec1_f32, %mask_scalable8, %vl6_i32) :
  //     (vector<[4]xf32>, vector<[4]xf32>, vector<[4]xi1>, i32) -> vector<[4]xf32>
  // call @print_scalable_vector_f32(%res_frem_evl_driven) : (vector<[4]xf32>) -> ()

  //===--------------------------------------------------------------------===//
  // VP Intrinsic SRem Operation + Scalable Vector Type
  //===--------------------------------------------------------------------===//

  // Mask-Driven
  %res_srem_mask_driven = "llvm.intr.vp.srem" (%load_vec2_i32, %load_vec1_i32, %mask_scalable6, %vl8_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_srem_mask_driven) : (vector<[4]xi32>) -> ()

  // EVL-Driven
  %res_srem_evl_driven = "llvm.intr.vp.srem" (%load_vec2_i32, %load_vec1_i32, %mask_scalable8, %vl6_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_srem_evl_driven) : (vector<[4]xi32>) -> ()

  //===--------------------------------------------------------------------===//
  // VP Intrinsic URem Operation + Scalable Vector Type
  //===--------------------------------------------------------------------===//

  // Mask-Driven
  %res_urem_mask_driven = "llvm.intr.vp.urem" (%load_vec2_i32, %load_vec1_i32, %mask_scalable6, %vl8_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_urem_mask_driven) : (vector<[4]xi32>) -> ()

  // EVL-Driven
  %res_urem_evl_driven = "llvm.intr.vp.urem" (%load_vec2_i32, %load_vec1_i32, %mask_scalable8, %vl6_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_urem_evl_driven) : (vector<[4]xi32>) -> ()
