...
func.func @main() -> i32 {
  ...
  // Mask-Driven
  %res_sub_mask_driven = "llvm.intr.vp.sub" (%load_vec2_i32, %load_vec1_i32, %mask_scalable6, %vl8_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_sub_mask_driven) : (vector<[4]xi32>) -> ()

  // EVL-Driven
  %res_sub_evl_driven = "llvm.intr.vp.sub" (%load_vec2_i32, %load_vec1_i32, %mask_scalable8, %vl6_i32) :
      (vector<[4]xi32>, vector<[4]xi32>, vector<[4]xi1>, i32) -> vector<[4]xi32>
  call @print_scalable_vector_i32(%res_sub_evl_driven) : (vector<[4]xi32>) -> ()
  ...
  // Mask-Driven
  %res_fsub_mask_driven = "llvm.intr.vp.fsub" (%load_vec2_f32, %load_vec1_f32, %mask_scalable6, %vl8_i32) :
      (vector<[4]xf32>, vector<[4]xf32>, vector<[4]xi1>, i32) -> vector<[4]xf32>
  call @print_scalable_vector_f32(%res_fsub_mask_driven) : (vector<[4]xf32>) -> ()

  // EVL-Driven
  %res_fsub_evl_driven = "llvm.intr.vp.fsub" (%load_vec2_f32, %load_vec1_f32, %mask_scalable8, %vl6_i32) :
      (vector<[4]xf32>, vector<[4]xf32>, vector<[4]xi1>, i32) -> vector<[4]xf32>
  call @print_scalable_vector_f32(%res_fsub_evl_driven) : (vector<[4]xf32>) -> ()
