...
//===----------------------------------------------------------------------===//
//
// Plain C on NH, UART at 0x310b0000, no MLIR. Overrides the weak
// bare_runtime_* hooks. RA is not started.
//
//===----------------------------------------------------------------------===//
...
// -O2 folds LHS + RHS into `li a0, 42`; this is a fixed PASS/FAIL tag.
#define LHS 40
#define RHS 2
