...
module  {
  ...
  func @main() {
    ...
    %const_in2D_tensor = arith.constant dense<1.> : tensor<1x16x16x4xf32>
    %const_filter2D_tensor = arith.constant dense<2.> : tensor<3x3x4x6xf32>
    %const_out2D_tensor = arith.constant dense<0.> : tensor<1x14x14x6xf32>
    ...
    %conv = linalg.conv_2d_nhwc_hwcf
        ...
        ins(%const_in2D_tensor, %const_filter2D_tensor : tensor<1x16x16x4xf32>, tensor<3x3x4x6xf32>)
        outs(%const_out2D_tensor : tensor<1x14x14x6xf32>) -> tensor<1x14x14x6xf32>
    ...
    %out2D_nhwc_ = tensor.cast %conv : tensor<1x14x14x6xf32> to tensor<*xf32>
