...
func.func @main() -> i32 {
  // vector.broadcast fills a value into all elements of a vector, like "std::fill"
  // in C++. (Note: vector.splat has been replaced by vector.broadcast in newer MLIR versions)
  %0 = arith.constant 10.0 : f32

  // Creates a vector of shape 3x2, filling %0 as all elements
  %1 = vector.broadcast %0 : f32 to vector<3x2xf32>
  ...
  // vector.broadcast can accept runtime values
