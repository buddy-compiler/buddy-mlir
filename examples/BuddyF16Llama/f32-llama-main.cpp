...
int main() {
  ...
  const std::string paramsDir = "../examples/BuddyF16Llama/f32-params.data";
  ...
  //  - Parameters: load parameters from the `params` file into the container.
  ...
  // for debug: run one llama inference
