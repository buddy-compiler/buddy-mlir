...
def main():
    for i in range(3, 10, 2):
        ...
        tensor_w = helper.make_tensor_value_info('w', TensorProto.FLOAT, [1, 1, i, i])
        tensor_x = helper.make_tensor_value_info('x', TensorProto.FLOAT, [1, 1, 2048, 2048])
        tensor_y = helper.make_tensor_value_info('y', TensorProto.FLOAT, get_output_shape(i))
