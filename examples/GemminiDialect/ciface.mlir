...
func.func @conv_2d_nchw_fchw1(%arg0 : memref<1x1x256x256xi8>, %arg1 : memref<1x1x3x3xi8>, %arg2 : memref<1x1x254x254xi8>) {
...
func.func @conv_2d_nchw_fchw2(%arg0 : memref<1x1x256x256xi8>, %arg1 : memref<1x1x5x5xi8>, %arg2 : memref<1x1x252x252xi8>) {
  linalg.conv_2d_nchw_fchw
...
func.func @conv_2d_nchw_fchw3(%arg0 : memref<1x1x256x256xi8>, %arg1 : memref<1x1x7x7xi8>, %arg2 : memref<1x1x250x250xi8>) {
  linalg.conv_2d_nchw_fchw
...
func.func @conv_2d_nchw_fchw4(%arg0 : memref<1x1x256x256xi8>, %arg1 : memref<1x1x9x9xi8>, %arg2 : memref<1x1x248x248xi8>) {
  linalg.conv_2d_nchw_fchw
...
func.func @conv_2d_nchw_fchw5(%arg0 : memref<1x1x256x256xi8>, %arg1 : memref<1x1x11x11xi8>, %arg2 : memref<1x1x246x246xi8>) {
  linalg.conv_2d_nchw_fchw
...
func.func @conv_2d_nchw_fchw6(%arg0 : memref<1x1x256x256xi8>, %arg1 : memref<1x1x13x13xi8>, %arg2 : memref<1x1x244x244xi8>) {
  linalg.conv_2d_nchw_fchw
