memref.global "private" @gv_i32 : memref<20xi32> = dense<[3, 5, 2, 8, 7, 1, 9, 4, 6, 10, 
                                                           13, 12, 15, 11, 14, 16, 19, 18, 17, 20]>
...
func.func @main() -> i32 {
  ...
  %res_max = rvv.max %vec_c0_i32, %vec_c10_i32, %vl8 : vector<[8]xi32>, vector<[8]xi32>, index
  %res_min = rvv.min %vec_c0_i32, %vec_c10_i32, %vl8 : vector<[8]xi32>, vector<[8]xi32>, index

  rvv.store %res_max, %res_mem[%c0], %vl8 : vector<[8]xi32>, memref<20xi32>, index
  rvv.store %res_min, %res_mem[%c10], %vl8 : vector<[8]xi32>, memref<20xi32>, index
