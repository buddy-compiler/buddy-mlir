...
# Retrieve the MobileNet V2 model path from environment variables.
model_path = os.environ.get("MOBILENETV2_EXAMPLE_PATH")
if model_path is None:
    raise EnvironmentError(
     "The environment variable 'MOBILENETV2_MODEL_PATH' is not set or is invalid."
    )
