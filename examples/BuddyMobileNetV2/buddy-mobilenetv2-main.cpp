...
constexpr size_t ParamsSize = 3538984;
...
const cv::Mat imagePreprocessing() {
  ...
  std::string mobilenetDir = getenv("MOBILENETV2_EXAMPLE_PATH");
...
int main() {
  ...
  const std::string title = "MobileNetV2 Inference Powered by Buddy Compiler";
  ...
  MemRef<long long, 1> ParamsInt64({52});
  loadParameters(paramsDir, intDir, paramsContainerf32, ParamsInt64);
  // Call the forward function of the model.
  _mlir_ciface_forward(&output, &paramsContainerf32, &ParamsInt64, &input);
