...
memref.global "private" @output : memref<1x2x4x1xf32> = dense<0.0>
...
func @main() {
  ...
  // output.
  %arg2 = memref.get_global @output : memref<1x2x4x1xf32>
  ...
  linalg.pooling_nhwc_sum
    ...
    outs(%arg2: memref<1x2x4x1xf32>)

  // Print output.
  %arg2_vec = vector.transfer_read %arg2[%cst0, %cst0, %cst0, %cst0], %cst1 : memref<1x2x4x1xf32>, vector<1x2x4x1xf32>
  vector.print %arg2_vec : vector<1x2x4x1xf32>
