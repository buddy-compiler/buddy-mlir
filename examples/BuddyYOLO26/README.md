...
This example demonstrates how to import and run the YOLO26n object detection model with Buddy Compiler.

1. Enter Python environment

We recommend using conda. Install Python dependencies as in buddy-mlir/requirements.txt:
...
If not provided, the importer will automatically download yolo26n.pt.
