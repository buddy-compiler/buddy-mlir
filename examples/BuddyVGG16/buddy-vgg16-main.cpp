...
const std::string ImgName = "tiger.JPEG";

/// Declare VGG16 forward function.
...
const cv::Mat imagePreprocessing() {
  // Get the directory of the VGG16 example and construct the image path.
