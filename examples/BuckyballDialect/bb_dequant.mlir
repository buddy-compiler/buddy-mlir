...
// Simple Dequant test using Bank SSA operations
// CHECK: bb_mset
// CHECK: bb_mvin
// CHECK: bb_dequant
// CHECK: bb_mvout
...
func.func @main() -> i8 {
  ...
  // Initialize: input[i,j] = (i + j) as i8
  ...
  scf.for %i = %c0 to %n step %c1 {
    scf.for %j = %c0 to %n step %c1 {
      ...
      %val = arith.trunci %sum : i32 to i8
      memref.store %val, %input[%i, %j] : memref<16x16xi8>
    }
  }
  ...
  memref.dealloc %output : memref<16x16xf32>
  return %zero : i8
}
