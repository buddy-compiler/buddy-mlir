...
const std::string ImgName = "tulips.jpg";
...
const cv::Mat imagePreprocessing() {
  ...
  std::string imgPath = vggDir + "/image/" + ImgName;
  // Read the image in grayscale mode.
  cv::Mat inputImage = cv::imread(imgPath,IMREAD_COLOR);
...
int main() {
  ...
  printLogLabel();
  std::cout<<"read image finish"<<std::endl;
  ...
  std::cout << "Classification: " << class_indices[maxIdx] << std::endl;
