...
# CHECK: run this example by hand :)
print("run this example by hand :)")
...
if __name__ == "__main__":
    ...
    Downloading: "https://github.com/NVIDIA/DeepLearningExamples/zipball/torchhub" to /home/xxx/.cache/torch/hub/torchhub.zip
    python: /home/xxx/buddy-mlir/llvm/llvm/include/llvm/Support/CommandLine.h:864: void llvm::cl::parser<DataType>::addLiteralOption(llvm::StringRef, const DT&, llvm::StringRef) [with DT = llvm::FunctionPass* (*)(); DataType = llvm::FunctionPass* (*)()]: Assertion `findOption(Name) == Values.size() && "Option already exists!"' failed.
    [1]    2152340 IOT instruction (core dumped)  python ./test_model_HIFIGAN.py
    """
