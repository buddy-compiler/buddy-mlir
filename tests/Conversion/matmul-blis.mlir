// RUN: buddy-opt %s \
// RUN:     -matmul-blis="k_c=128 m_c=256 n_c=2048 m_r=8 n_r=4" \
// RUN:     -convert-linalg-to-loops -lower-affine -convert-scf-to-cf \
// RUN:     -convert-vector-to-llvm -expand-strided-metadata -finalize-memref-to-llvm -convert-arith-to-llvm -convert-cf-to-llvm \
