...
module attributes {gpu.container_module} {
  memref.global "private" constant @__constant_1x10x10xf32 : memref<1x10x10xf32> = dense<1.000000e+00> alignment = 64
  func.func @matmul(%arg0: memref<1x10x10xf32>, %arg1: memref<1x10x10xf32>) -> memref<1x10x10xf32> {
    ...
    %alloc = memref.alloc() alignment = 64 : memref<1x10x10xf32>
    ...
    %alloc_0 = memref.alloc() alignment = 64 : memref<1x10x10xf32>
    // CHECK: gpu.launch_func
    ...
    %alloc_1 = memref.alloc() alignment = 64 : memref<1x10x10xf32>
    // CHECK: gpu.launch_func
