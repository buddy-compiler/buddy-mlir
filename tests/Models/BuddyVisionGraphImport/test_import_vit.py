...
if build_dir:
    output_dir = Path(build_dir) / "tests/Models/BuddyVisionGraphImport/vit"
else:
    repo_root = script_dir.parent.parent.parent
    output_dir = repo_root / "build/tests/Models/BuddyVisionGraphImport/vit"
...
print(f"Loading ViT model config from: {model_path}")
...
print("✓ ViT graph construction test PASSED")
