...
if build_dir:
    output_dir = Path(build_dir) / "tests/Models/BuddyLLMGraphImport/gpt2"
else:
    repo_root = script_dir.parent.parent.parent
    output_dir = repo_root / "build/tests/Models/BuddyLLMGraphImport/gpt2"
...
print(f"Loading GPT-2 model config from: {model_path}")
...
print("✓ GPT-2 graph construction test PASSED")
