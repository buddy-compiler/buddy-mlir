...
if build_dir:
    output_dir = Path(build_dir) / "tests/Models/BuddyLLMGraphImport/bart"
else:
    repo_root = script_dir.parent.parent.parent
    output_dir = repo_root / "build/tests/Models/BuddyLLMGraphImport/bart"
output_dir.mkdir(parents=True, exist_ok=True)

# Retrieve model path from environment variable
model_path = os.environ.get("BART_MODEL_PATH")
if model_path is None:
    model_path = "facebook/bart-base"

print(f"Loading BART model config from: {model_path}")
...
print("✓ BART graph construction test PASSED")
