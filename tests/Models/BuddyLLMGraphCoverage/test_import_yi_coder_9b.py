...
# ===---------------------------------------------------------------------------
#
# This is the graph coverage test for Yi-Coder-9B-Chat model.
#
# ===---------------------------------------------------------------------------
...
parser = argparse.ArgumentParser(description="Yi-Coder-9B graph coverage test")
parser.add_argument(
    "--output-dir",
    type=str,
    default=None,
    help="Directory to save output MLIR files (default: build/tests/Models/BuddyLLMGraphCoverage/yi_coder_9b)",
)
...
if args.output_dir is None:
    ...
    if build_dir:
        output_dir = (
            Path(build_dir) / "tests/Models/BuddyLLMGraphCoverage/yi_coder_9b"
        )
    else:
        repo_root = script_dir.parent.parent.parent
        output_dir = (
            repo_root / "build/tests/Models/BuddyLLMGraphCoverage/yi_coder_9b"
        )
else:
...
model_path = os.environ.get("YI_CODER_9B_MODEL_PATH")
if model_path is None:
    model_path = "01-ai/Yi-Coder-9B-Chat"

print(f"Loading Yi-Coder-9B model from: {model_path}")
...
print("✓ Yi-Coder-9B-Chat graph construction test PASSED")
