...
struct LegalizeXTAMEForLLVMExport
  ...
  void runOnOperation() override {
    ...
    patterns.add<XTAMEConfigLowering<ThMcfgOp>>(typeConverter,
                                                "llvm.riscv.buddy.th.mcfg");
    patterns.add<XTAMEConfigLowering<ThMcfgmOp>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mcfgm");
    patterns.add<XTAMEConfigLowering<ThMcfgnOp>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mcfgn");
    patterns.add<XTAMEConfigLowering<ThMcfgkOp>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mcfgk");
    patterns.add<XTAMEConfigImmLowering<ThMcfgmiOp, &ThMcfgmiOp::getTilem>>(
        typeConverter, "llvm.riscv.buddy.th.mcfgmi");
    patterns.add<XTAMEConfigImmLowering<ThMcfgniOp, &ThMcfgniOp::getTilen>>(
        typeConverter, "llvm.riscv.buddy.th.mcfgni");
    patterns.add<XTAMEConfigImmLowering<ThMcfgkiOp, &ThMcfgkiOp::getTilek>>(
        typeConverter, "llvm.riscv.buddy.th.mcfgki");

    // MISC patterns
    patterns.add<XTAMEZeroLowering<ThMzeroOp>>(typeConverter,
                                               "llvm.riscv.buddy.th.mzero");
    patterns.add<XTAMEZeroLowering<ThMzero2rOp>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mzero2r");
    patterns.add<XTAMEZeroLowering<ThMzero4rOp>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mzero4r");
    patterns.add<XTAMEZeroLowering<ThMzero8rOp>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mzero8r");
    patterns.add<XTAMEDualAttrLowering<ThMmovMmOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmov.mm");
    patterns.add<XTAMEDupLowering<ThMdupbMXOp>>(
        typeConverter, "llvm.riscv.buddy.th.mdupb.m.x");
    patterns.add<XTAMEDupLowering<ThMduphMXOp>>(
        typeConverter, "llvm.riscv.buddy.th.mduph.m.x");
    patterns.add<XTAMEDupLowering<ThMdupwMXOp>>(
        typeConverter, "llvm.riscv.buddy.th.mdupw.m.x");
    patterns.add<XTAMEDupLowering<ThMdupdMXOp>>(
        typeConverter, "llvm.riscv.buddy.th.mdupd.m.x");
    patterns.add<XTAMEMmovMXLowering<ThMmovbMXOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmovb.m.x");
    patterns.add<XTAMEMmovMXLowering<ThMmovhMXOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmovh.m.x");
    patterns.add<XTAMEMmovMXLowering<ThMmovwMXOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmovw.m.x");
    patterns.add<XTAMEMmovMXLowering<ThMmovdMXOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmovd.m.x");
    patterns.add<XTAMEMmovXMLowering<ThMmovbXMOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmovb.x.m");
    patterns.add<XTAMEMmovXMLowering<ThMmovhXMOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmovh.x.m");
    patterns.add<XTAMEMmovXMLowering<ThMmovwXMOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmovw.x.m");
    patterns.add<XTAMEMmovXMLowering<ThMmovdXMOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmovd.x.m");
    patterns.add<XTAMECmovMvILowering<ThMmovMvIOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmov.mv.i");
    patterns.add<XTAMECmovMvILowering<ThMcmovbMvIOp>>(
        typeConverter, "llvm.riscv.buddy.th.mcmovb.mv.i");
    patterns.add<XTAMECmovMvILowering<ThMcmovhMvIOp>>(
        typeConverter, "llvm.riscv.buddy.th.mcmovh.mv.i");
    patterns.add<XTAMECmovMvILowering<ThMcmovwMvIOp>>(
        typeConverter, "llvm.riscv.buddy.th.mcmovw.mv.i");
    patterns.add<XTAMECmovMvILowering<ThMcmovdMvIOp>>(
        typeConverter, "llvm.riscv.buddy.th.mcmovd.mv.i");
    patterns.add<XTAMETernaryOpLowering<ThMpackMmOp>>(
        typeConverter, "llvm.riscv.buddy.th.mpack.mm");
    patterns.add<XTAMETernaryOpLowering<ThMpackhlMmOp>>(
        typeConverter, "llvm.riscv.buddy.th.mpackhl.mm");
    patterns.add<XTAMETernaryOpLowering<ThMpackhhMmOp>>(
        typeConverter, "llvm.riscv.buddy.th.mpackhh.mm");

    // Load/Store patterns
    patterns.add<XTAMELoadLowering<ThMlde8Op>>(typeConverter,
                                               "llvm.riscv.buddy.th.mlde8");
    patterns.add<XTAMELoadLowering<ThMlde16Op>>(typeConverter,
                                                "llvm.riscv.buddy.th.mlde16");
    patterns.add<XTAMELoadLowering<ThMlde32Op>>(typeConverter,
                                                "llvm.riscv.buddy.th.mlde32");
    patterns.add<XTAMELoadLowering<ThMlde64Op>>(typeConverter,
                                                "llvm.riscv.buddy.th.mlde64");
    patterns.add<XTAMELoadLowering<ThMldte8Op>>(typeConverter,
                                                "llvm.riscv.buddy.th.mldte8");
    patterns.add<XTAMELoadLowering<ThMldte16Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mldte16");
    patterns.add<XTAMELoadLowering<ThMldte32Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mldte32");
    patterns.add<XTAMELoadLowering<ThMldte64Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mldte64");
    patterns.add<XTAMELoadLowering<ThMslde8Op>>(typeConverter,
                                                "llvm.riscv.buddy.th.mslde8");
    patterns.add<XTAMELoadLowering<ThMslde16Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mslde16");
    patterns.add<XTAMELoadLowering<ThMslde32Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mslde32");
    patterns.add<XTAMELoadLowering<ThMslde64Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mslde64");
    patterns.add<XTAMELoadLowering<ThMsldte8Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.msldte8");
    patterns.add<XTAMELoadLowering<ThMsldte16Op>>(
        typeConverter, "llvm.riscv.buddy.th.msldte16");
    patterns.add<XTAMELoadLowering<ThMsldte32Op>>(
        typeConverter, "llvm.riscv.buddy.th.msldte32");
    patterns.add<XTAMELoadLowering<ThMsldte64Op>>(
        typeConverter, "llvm.riscv.buddy.th.msldte64");

    patterns.add<XTAMEPrefetchLowering<ThMplde8Op>>(
        typeConverter, "llvm.riscv.buddy.th.mplde8");
    patterns.add<XTAMEPrefetchLowering<ThMplde16Op>>(
        typeConverter, "llvm.riscv.buddy.th.mplde16");
    patterns.add<XTAMEPrefetchLowering<ThMplde32Op>>(
        typeConverter, "llvm.riscv.buddy.th.mplde32");
    patterns.add<XTAMEPrefetchLowering<ThMplde64Op>>(
        typeConverter, "llvm.riscv.buddy.th.mplde64");
    patterns.add<XTAMEPrefetchLowering<ThMpldte8Op>>(
        typeConverter, "llvm.riscv.buddy.th.mpldte8");
    patterns.add<XTAMEPrefetchLowering<ThMpldte16Op>>(
        typeConverter, "llvm.riscv.buddy.th.mpldte16");
    patterns.add<XTAMEPrefetchLowering<ThMpldte32Op>>(
        typeConverter, "llvm.riscv.buddy.th.mpldte32");
    patterns.add<XTAMEPrefetchLowering<ThMpldte64Op>>(
        typeConverter, "llvm.riscv.buddy.th.mpldte64");

    patterns.add<XTAMEStoreLowering<ThMste8Op>>(typeConverter,
                                                "llvm.riscv.buddy.th.mste8");
    patterns.add<XTAMEStoreLowering<ThMste16Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mste16");
    patterns.add<XTAMEStoreLowering<ThMste32Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mste32");
    patterns.add<XTAMEStoreLowering<ThMste64Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mste64");
    patterns.add<XTAMEStoreLowering<ThMstte8Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.mstte8");
    patterns.add<XTAMEStoreLowering<ThMstte16Op>>(
        typeConverter, "llvm.riscv.buddy.th.mstte16");
    patterns.add<XTAMEStoreLowering<ThMstte32Op>>(
        typeConverter, "llvm.riscv.buddy.th.mstte32");
    patterns.add<XTAMEStoreLowering<ThMstte64Op>>(
        typeConverter, "llvm.riscv.buddy.th.mstte64");
    patterns.add<XTAMEStoreLowering<ThMsste8Op>>(typeConverter,
                                                 "llvm.riscv.buddy.th.msste8");
    patterns.add<XTAMEStoreLowering<ThMsste16Op>>(
        typeConverter, "llvm.riscv.buddy.th.msste16");
    patterns.add<XTAMEStoreLowering<ThMsste32Op>>(
        typeConverter, "llvm.riscv.buddy.th.msste32");
    patterns.add<XTAMEStoreLowering<ThMsste64Op>>(
        typeConverter, "llvm.riscv.buddy.th.msste64");
    patterns.add<XTAMEStoreLowering<ThMsstte8Op>>(
        typeConverter, "llvm.riscv.buddy.th.msstte8");
    patterns.add<XTAMEStoreLowering<ThMsstte16Op>>(
        typeConverter, "llvm.riscv.buddy.th.msstte16");
    patterns.add<XTAMEStoreLowering<ThMsstte32Op>>(
        typeConverter, "llvm.riscv.buddy.th.msstte32");
    patterns.add<XTAMEStoreLowering<ThMsstte64Op>>(
        typeConverter, "llvm.riscv.buddy.th.msstte64");

    // Tile register matrix multiply patterns
    patterns.add<XTAMETernaryOpLowering<ThMmaccWBOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmacc.w.b");
    patterns.add<XTAMETernaryOpLowering<ThMmaccuWBOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmaccu.w.b");
    patterns.add<XTAMETernaryOpLowering<ThMmaccusWBOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmaccus.w.b");
    patterns.add<XTAMETernaryOpLowering<ThMmaccsuWBOp>>(
        typeConverter, "llvm.riscv.buddy.th.mmaccsu.w.b");

    patterns.add<XTAMETernaryOpLowering<ThMfmaccHOp>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.h");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccBf16Op>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.bf16");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccSOp>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.s");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccDOp>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.d");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccHE4m3Op>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.h.e4m3");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccHE5m2Op>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.h.e5m2");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccBf16E4m3Op>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.bf16.e4m3");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccBf16E5m2Op>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.bf16.e5m2");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccSHOp>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.s.h");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccSBf16Op>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.s.bf16");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccDSOp>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.d.s");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccSE4m3Op>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.s.e4m3");
    patterns.add<XTAMETernaryOpLowering<ThMfmaccSE5m2Op>>(
        typeConverter, "llvm.riscv.buddy.th.mfmacc.s.e5m2");
...
void mlir::populateXTAMELegalizeForLLVMExportPatterns(
  ...
  // Configuration patterns
  patterns.add<XTAMEConfigLowering<ThMcfgOp>>(converter,
                                              "llvm.riscv.buddy.th.mcfg");
  ...
  patterns.add<XTAMEConfigLowering<ThMcfgkOp>>(converter,
                                               "llvm.riscv.buddy.th.mcfgk");
  patterns.add<XTAMEConfigImmLowering<ThMcfgmiOp, &ThMcfgmiOp::getTilem>>(
      converter, "llvm.riscv.buddy.th.mcfgmi");
  patterns.add<XTAMEConfigImmLowering<ThMcfgniOp, &ThMcfgniOp::getTilen>>(
      converter, "llvm.riscv.buddy.th.mcfgni");
  patterns.add<XTAMEConfigImmLowering<ThMcfgkiOp, &ThMcfgkiOp::getTilek>>(
      converter, "llvm.riscv.buddy.th.mcfgki");

  // MISC patterns
  patterns.add<XTAMEZeroLowering<ThMzeroOp>>(converter,
                                             "llvm.riscv.buddy.th.mzero");
  ...
  patterns.add<XTAMEZeroLowering<ThMzero8rOp>>(converter,
                                               "llvm.riscv.buddy.th.mzero8r");
  patterns.add<XTAMEDualAttrLowering<ThMmovMmOp>>(
      converter, "llvm.riscv.buddy.th.mmov.mm");
  patterns.add<XTAMEDupLowering<ThMdupbMXOp>>(converter,
                                              "llvm.riscv.buddy.th.mdupb.m.x");
  patterns.add<XTAMEDupLowering<ThMduphMXOp>>(converter,
                                              "llvm.riscv.buddy.th.mduph.m.x");
  patterns.add<XTAMEDupLowering<ThMdupwMXOp>>(converter,
                                              "llvm.riscv.buddy.th.mdupw.m.x");
  patterns.add<XTAMEDupLowering<ThMdupdMXOp>>(converter,
                                              "llvm.riscv.buddy.th.mdupd.m.x");
  patterns.add<XTAMEMmovMXLowering<ThMmovbMXOp>>(
      converter, "llvm.riscv.buddy.th.mmovb.m.x");
  patterns.add<XTAMEMmovMXLowering<ThMmovhMXOp>>(
      converter, "llvm.riscv.buddy.th.mmovh.m.x");
  patterns.add<XTAMEMmovMXLowering<ThMmovwMXOp>>(
      converter, "llvm.riscv.buddy.th.mmovw.m.x");
  patterns.add<XTAMEMmovMXLowering<ThMmovdMXOp>>(
      converter, "llvm.riscv.buddy.th.mmovd.m.x");
  patterns.add<XTAMEMmovXMLowering<ThMmovbXMOp>>(
      converter, "llvm.riscv.buddy.th.mmovb.x.m");
  patterns.add<XTAMEMmovXMLowering<ThMmovhXMOp>>(
      converter, "llvm.riscv.buddy.th.mmovh.x.m");
  patterns.add<XTAMEMmovXMLowering<ThMmovwXMOp>>(
      converter, "llvm.riscv.buddy.th.mmovw.x.m");
  patterns.add<XTAMEMmovXMLowering<ThMmovdXMOp>>(
      converter, "llvm.riscv.buddy.th.mmovd.x.m");
  patterns.add<XTAMECmovMvILowering<ThMmovMvIOp>>(
      converter, "llvm.riscv.buddy.th.mmov.mv.i");
  patterns.add<XTAMECmovMvILowering<ThMcmovbMvIOp>>(
      converter, "llvm.riscv.buddy.th.mcmovb.mv.i");
  patterns.add<XTAMECmovMvILowering<ThMcmovhMvIOp>>(
      converter, "llvm.riscv.buddy.th.mcmovh.mv.i");
  patterns.add<XTAMECmovMvILowering<ThMcmovwMvIOp>>(
      converter, "llvm.riscv.buddy.th.mcmovw.mv.i");
  patterns.add<XTAMECmovMvILowering<ThMcmovdMvIOp>>(
      converter, "llvm.riscv.buddy.th.mcmovd.mv.i");
  patterns.add<XTAMETernaryOpLowering<ThMpackMmOp>>(
      converter, "llvm.riscv.buddy.th.mpack.mm");
  patterns.add<XTAMETernaryOpLowering<ThMpackhlMmOp>>(
      converter, "llvm.riscv.buddy.th.mpackhl.mm");
  patterns.add<XTAMETernaryOpLowering<ThMpackhhMmOp>>(
      converter, "llvm.riscv.buddy.th.mpackhh.mm");

  // Load/Store patterns
  patterns.add<XTAMELoadLowering<ThMlde8Op>>(converter,
                                             "llvm.riscv.buddy.th.mlde8");
  ...
  patterns.add<XTAMELoadLowering<ThMsldte16Op>>(converter,
                                                "llvm.riscv.buddy.th.msldte16");
  patterns.add<XTAMELoadLowering<ThMsldte32Op>>(converter,
                                                "llvm.riscv.buddy.th.msldte32");
  patterns.add<XTAMELoadLowering<ThMsldte64Op>>(converter,
                                                "llvm.riscv.buddy.th.msldte64");

  patterns.add<XTAMEPrefetchLowering<ThMplde8Op>>(converter,
                                                  "llvm.riscv.buddy.th.mplde8");
  patterns.add<XTAMEPrefetchLowering<ThMplde16Op>>(
      converter, "llvm.riscv.buddy.th.mplde16");
  patterns.add<XTAMEPrefetchLowering<ThMplde32Op>>(
      converter, "llvm.riscv.buddy.th.mplde32");
  patterns.add<XTAMEPrefetchLowering<ThMplde64Op>>(
      converter, "llvm.riscv.buddy.th.mplde64");
  patterns.add<XTAMEPrefetchLowering<ThMpldte8Op>>(
      converter, "llvm.riscv.buddy.th.mpldte8");
  patterns.add<XTAMEPrefetchLowering<ThMpldte16Op>>(
      converter, "llvm.riscv.buddy.th.mpldte16");
  patterns.add<XTAMEPrefetchLowering<ThMpldte32Op>>(
      converter, "llvm.riscv.buddy.th.mpldte32");
  patterns.add<XTAMEPrefetchLowering<ThMpldte64Op>>(
      converter, "llvm.riscv.buddy.th.mpldte64");

  patterns.add<XTAMEStoreLowering<ThMste8Op>>(converter,
                                              "llvm.riscv.buddy.th.mste8");
  ...
  patterns.add<XTAMEStoreLowering<ThMstte16Op>>(converter,
                                                "llvm.riscv.buddy.th.mstte16");
  patterns.add<XTAMEStoreLowering<ThMstte32Op>>(converter,
                                                "llvm.riscv.buddy.th.mstte32");
  patterns.add<XTAMEStoreLowering<ThMstte64Op>>(converter,
                                                "llvm.riscv.buddy.th.mstte64");
  patterns.add<XTAMEStoreLowering<ThMsste8Op>>(converter,
                                               "llvm.riscv.buddy.th.msste8");
  patterns.add<XTAMEStoreLowering<ThMsste16Op>>(converter,
                                                "llvm.riscv.buddy.th.msste16");
  patterns.add<XTAMEStoreLowering<ThMsste32Op>>(converter,
                                                "llvm.riscv.buddy.th.msste32");
  patterns.add<XTAMEStoreLowering<ThMsste64Op>>(converter,
                                                "llvm.riscv.buddy.th.msste64");
  patterns.add<XTAMEStoreLowering<ThMsstte8Op>>(converter,
                                                "llvm.riscv.buddy.th.msstte8");
  patterns.add<XTAMEStoreLowering<ThMsstte16Op>>(
      converter, "llvm.riscv.buddy.th.msstte16");
  patterns.add<XTAMEStoreLowering<ThMsstte32Op>>(
      converter, "llvm.riscv.buddy.th.msstte32");
  patterns.add<XTAMEStoreLowering<ThMsstte64Op>>(
      converter, "llvm.riscv.buddy.th.msstte64");

  patterns.add<XTAMETernaryOpLowering<ThMmaccWBOp>>(
      converter, "llvm.riscv.buddy.th.mmacc.w.b");
  patterns.add<XTAMETernaryOpLowering<ThMmaccuWBOp>>(
      converter, "llvm.riscv.buddy.th.mmaccu.w.b");
  patterns.add<XTAMETernaryOpLowering<ThMmaccusWBOp>>(
      converter, "llvm.riscv.buddy.th.mmaccus.w.b");
  patterns.add<XTAMETernaryOpLowering<ThMmaccsuWBOp>>(
      converter, "llvm.riscv.buddy.th.mmaccsu.w.b");

  // Tile register matrix multiply patterns (float-point types)
  patterns.add<XTAMETernaryOpLowering<ThMfmaccHOp>>(
      converter, "llvm.riscv.buddy.th.mfmacc.h");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccBf16Op>>(
      converter, "llvm.riscv.buddy.th.mfmacc.bf16");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccSOp>>(
      converter, "llvm.riscv.buddy.th.mfmacc.s");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccDOp>>(
      converter, "llvm.riscv.buddy.th.mfmacc.d");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccHE4m3Op>>(
      converter, "llvm.riscv.buddy.th.mfmacc.h.e4m3");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccHE5m2Op>>(
      converter, "llvm.riscv.buddy.th.mfmacc.h.e5m2");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccBf16E4m3Op>>(
      converter, "llvm.riscv.buddy.th.mfmacc.bf16.e4m3");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccBf16E5m2Op>>(
      converter, "llvm.riscv.buddy.th.mfmacc.bf16.e5m2");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccSHOp>>(
      converter, "llvm.riscv.buddy.th.mfmacc.s.h");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccSBf16Op>>(
      converter, "llvm.riscv.buddy.th.mfmacc.s.bf16");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccDSOp>>(
      converter, "llvm.riscv.buddy.th.mfmacc.d.s");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccSE4m3Op>>(
      converter, "llvm.riscv.buddy.th.mfmacc.s.e4m3");
  patterns.add<XTAMETernaryOpLowering<ThMfmaccSE5m2Op>>(
      converter, "llvm.riscv.buddy.th.mfmacc.s.e5m2");
}
