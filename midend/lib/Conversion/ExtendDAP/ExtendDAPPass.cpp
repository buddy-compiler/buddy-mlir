...
//                         // VectorType vecTy =
//                         VectorType::get({(long)values.size()}, valueTy);
//                         // Value vec = builder.create<vector::SplatOp>(loc,
//                         vecTy, *values.begin());

//   FloatType f64Ty = builder.getF64Type();
//   int64_t inputLength = 400;

//   Value f1 = builder.create<ConstantFloatOp>(loc, APFloat(double(1.0)),
//   f64Ty);
...
//   std::vector<Value> plan = make_rfftp_plan(builder, loc, inputLength);
...
// //   rfftp_forward(builder, loc, Rfftp_fctdata_fct, Rfftp_fctdata_tw,
// //                 Rfftp_fctdata_tws, Rfftp_plan_length, Rfftp_plan_nfct,
// //                 Rfftp_plan_mem, ch, f1);
...
//       0.876307, 0.481754,  0.809017, 0.587785,  0.728969, 0.684547, 0.637424,
//       0.770513, 0.535827,  0.844328, 0.425779,  0.904827, 0.309017, 0.951057,
//       0.187381, 0.982287,  0.062791, 0.998027,  0.982287, 0.187381, 0.929776,
//       0.368125, 0.844328,  0.535827, 0.728969,  0.684547, 0.587785, 0.809017,
//       0.425779, 0.904827,  0.248690, 0.968583,  0.062791, 0.998027,
//       -0.125333, 0.992115, -0.309017, 0.951057, -0.481754, 0.876307,
//       -0.637424, 0.770513};
