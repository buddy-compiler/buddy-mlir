...
/// 针对 linalg::GenericOp 的转置操作进行向量化优化。
    ...
    public:
        ...
        matchAndRewrite(GenericOp genericOp, OpAdaptor adaptor,
            ...
            Value transposedOutput = createNestedLoops(rewriter, loc, input, output, dims, elementType, 0, inputIndices,
                                                       outputIndices, index0, innerUpperBound, zeroElementType,
                                                       readShape,
                ...
                rewriter.create<affine::AffineForOp>(
                        ...
                        [&](OpBuilder &nestedBuilder, Location nestedLoc, Value iv,
                            ...
                            createNestedLoops(rewriter, loc, input, output, dims, elementType,
                                              ...
                                              innerUpperBound, zeroElementType, readShape,
                                              writeShape, readMask, writeMask);
...
explicit GenericOpTransposeVectorizationPass(int64_t
affineVectorSizeParam) {
...
patterns.
add<GenericOpTransposeVectorizationPattern>(context,
        affineVectorSize
);
if (
