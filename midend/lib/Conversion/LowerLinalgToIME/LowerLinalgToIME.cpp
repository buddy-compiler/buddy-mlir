...
public:
  ...
  LogicalResult matchAndRewrite(linalg::MatmulOp matmulOp,
    ...
    Value numTilesMVal = arith::ConstantIndexOp::create(rewriter, loc, numTilesM);
    Value numTilesKVal = arith::ConstantIndexOp::create(rewriter, loc, numTilesK);
    Value numTilesNVal = arith::ConstantIndexOp::create(rewriter, loc, numTilesN);
    ...
    Value zeroC = arith::ConstantOp::create(rewriter, 
    ...
    Value inBoundM = arith::CmpIOp::create(rewriter, 
        loc, arith::CmpIPredicate::ult, globalCi, boundM);
    Value inBoundN = arith::CmpIOp::create(rewriter, 
    ...
    auto selectC = scf::IfOp::create(rewriter, 
        loc, CElemType, inBound, /*withElseRegion=*/true);
    rewriter.setInsertionPointToStart(&selectC.getThenRegion().front());
    Value cLoadVal = memref::LoadOp::create(rewriter, loc, C, ValueRange{globalCi, globalCj});
    ...
    memref::StoreOp::create(rewriter, loc, selectC.getResult(0), CTile, ValueRange{initCi, initCj});
    ...
    memref::StoreOp::create(rewriter, loc, selectA.getResult(0), ATile, ValueRange{copyAi, copyAk});
    ...
    Value bLoadVal = memref::LoadOp::create(rewriter, loc, B, ValueRange{globalBk, globalBn});
    ...
    memref::StoreOp::create(rewriter, loc, selectB.getResult(0), BTile, ValueRange{copyBn, copyBk});
    ...
    Value inBoundStoreM = arith::CmpIOp::create(rewriter, 
        loc, arith::CmpIPredicate::ult, globalStoreCi, boundM);
    Value inBoundStoreN = arith::CmpIOp::create(rewriter, 
        loc, arith::CmpIPredicate::ult, globalStoreCj, boundN);
    Value inBoundStore = arith::AndIOp::create(rewriter, loc, inBoundStoreM, inBoundStoreN);

    auto storeIf = scf::IfOp::create(rewriter, loc, inBoundStore, /*withElseRegion=*/false);
    rewriter.setInsertionPointToStart(&storeIf.getThenRegion().front());
    Value cResult = memref::LoadOp::create(rewriter, loc, CTile, ValueRange{storeCi, storeCj});
    memref::StoreOp::create(rewriter, loc, cResult, C, ValueRange{globalStoreCi, globalStoreCj});
...
public:
  ...
  LogicalResult matchAndRewrite(linalg::Conv2DNhwcHwcfOp convOp,
    ...
    Value mTimesStride = arith::MulIOp::create(rewriter, loc, fillM, strideHVal);
    ...
    Value inputVal = memref::LoadOp::create(rewriter, 
    ...
    Value filterVal = memref::LoadOp::create(rewriter, 
    ...
    Value outVal = memref::LoadOp::create(rewriter, 
    ...
    if (strideH == 1) {
      ...
      VmadotnOp::create(rewriter, loc, outputTile, inputTile, filterTile, slide);
    }

    auto storeOutputLoop = scf::ForOp::create(rewriter, loc, c0, tileMBound, c1);
    ...
    Value storeVal = memref::LoadOp::create(rewriter, 
