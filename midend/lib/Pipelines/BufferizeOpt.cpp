...
void mlir::buddy::createBufferizeOptPipeline(OpPassManager &pm, 
    ...
    mlir::buddy::invokeOpPassPipelineBuilder(
        [&](OpPassManager &pm) {
            ...
            bufferizeOptions.setFunctionBoundaryTypeConversion(bufferization::LayoutMapOption::IdentityLayoutMap);
            bufferizeOptions.allocationFn = [](OpBuilder &b, Location loc, MemRefType type,
                                            ValueRange dynShape,
