...
public:
  ...
  visitLexerGrammarNode(FegenParser::LexerGrammarNodeContext *ctx) override {
    ...
    auto content =
        std::any_cast<std::string>(this->visit(ctx->lexerGrammarSpec()));
  ...
  std::any
  visitLexerGrammarSpec(FegenParser::LexerGrammarSpecContext *ctx) override {
  ...
  visitParserGrammarNode(FegenParser::ParserGrammarNodeContext *ctx) override {
    ...
    auto content =
        std::any_cast<std::string>(this->visit(ctx->parserGrammarSpec()));
  ...
  std::any
  visitParserGrammarSpec(FegenParser::ParserGrammarSpecContext *ctx) override {
