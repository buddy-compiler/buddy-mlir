...
# ===----------------------------------------------------------------------===//
#
# Fetches the header-only third-party libraries used by buddy-mlir. Both are
# enabled by default; set BUDDY_DOWNLOAD_JSONCONS / BUDDY_DOWNLOAD_CLI11 to OFF
# for offline builds and provide the headers on the include path instead.
#
# ===----------------------------------------------------------------------===//

include(FetchContent)

# ── jsoncons: JSON parsing (BGE-M3 tokenizer, LLM chat templates) ────────────
...
# ── CLI11: command line parsing for buddy-cli ────────────────────────────────
