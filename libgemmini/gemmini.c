...
void _mlir_ciface_mvin(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_MVIN);
}

void _mlir_ciface_mvin2(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_MVIN2);
}

void _mlir_ciface_mvin3(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_MVIN3);
}

void _mlir_ciface_mvout(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_MVOUT);
}

void _mlir_ciface_flush(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_FLUSH);
}

void _mlir_ciface_config_ld(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_CONFIG);
}

void _mlir_ciface_config_st(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_CONFIG);
}

void _mlir_ciface_config_ex(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_CONFIG);
}

void _mlir_ciface_config_norm(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_CONFIG);
}

void _mlir_ciface_preload(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_PRELOAD);
}

void _mlir_ciface_compute_preloaded(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_COMPUTE_PRELOADED);
}

void _mlir_ciface_compute_accumulated(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_COMPUTE_ACCUMULATE);
}

void _mlir_ciface_loop_ws_config_bounds(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_WS_CONFIG_BOUNDS);
}

void _mlir_ciface_loop_ws_config_addrs_ab(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_WS_CONFIG_ADDRS_AB);
}

void _mlir_ciface_loop_ws_config_addrs_dc(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_WS_CONFIG_ADDRS_DC);
}

void _mlir_ciface_loop_ws_config_strides_ab(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_WS_CONFIG_STRIDES_AB);
}

void _mlir_ciface_loop_ws_config_strides_dc(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_WS_CONFIG_STRIDES_DC);
}

void _mlir_ciface_loop_ws(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_WS);
}

void _mlir_ciface_loop_conv_ws(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_CONV_WS);
}

void _mlir_ciface_loop_conv_ws_config1(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_CONV_WS_CONFIG_1);
}

void _mlir_ciface_loop_conv_ws_config2(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_CONV_WS_CONFIG_2);
}

void _mlir_ciface_loop_conv_ws_config3(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_CONV_WS_CONFIG_3);
}

void _mlir_ciface_loop_conv_ws_config4(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_CONV_WS_CONFIG_4);
}

void _mlir_ciface_loop_conv_ws_config5(reg_t rs1, reg_t rs2) {
    ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC, rs1, rs2, k_LOOP_CONV_WS_CONFIG_5);
}

void _mlir_ciface_loop_conv_ws_config6(reg_t rs1, reg_t rs2) {
