// LinalgBench: linalg.pooling_nwc_max (NWC layout).
module {
  func.func @pooling_nwc_max(%input: tensor<1x2048x128xf32>, %window: tensor<3xf32>, %init: tensor<1x2046x128xf32>) -> tensor<1x2046x128xf32> {
