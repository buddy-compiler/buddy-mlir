...
void SmolVLM2Runner::run(const RunConfig &cfgIn) {
  RunConfig cfg = cfgIn;
  if (!cfg.suppressStats) std::cerr << "\033[32;1mSmolVLM2 Inference (buddy-cli / BuddyRuntime)\033[0m\n";
  ...
  std::cout << "SmolVLM2 inference done.\n";
} } }
