#!/usr/bin/env python3
# ===- gen_smolvlm2_manifest.py - RHAL manifest for SmolVLM2 ----------------===//
#
...
#
# Usage:
#   python gen_smolvlm2_manifest.py --spec specs/f32.json -o smolvlm2.mlir
#
# The buffer/function layout mirrors the AOT forward ABI produced by
# codegen/import-smolvlm2.py (the traced SmolVLM2 text_model, Llama3 decoder):
...
def gen_manifest(spec: dict, runner_library: str) -> str:
    ...
    num_hidden_layers = int(spec.get("num_hidden_layers", 0))
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate RHAL manifest for the SmolVLM2 model."
    )
    parser.add_argument(
