...
// The pointer arithmetic uses sizeof(MemRef<...>) for correct alignment
// (alignas).
//===----------------------------------------------------------------------===//
...
void ModelSession::allocateKVCache() {
  ...
  // --- KV cache: one MemRef per layer, constructed in-place ---
...
void ModelSession::loadWeights(const std::vector<std::string> &paths) {
  if (paths.size() < 1u)
    throw std::runtime_error("[BuddyRuntime] Expected 1 weight file(s), got " +
                             std::to_string(paths.size()));

  {
    intptr_t shape[1] = {BUDDY_DSR1_PARAMS_SIZE};
    params_ = std::make_unique<MemRef<float, 1>>(shape);
    std::ifstream f(paths[0], std::ios::binary);
    if (!f)
      throw std::runtime_error("[BuddyRuntime] Cannot open weights: " +
                               paths[0]);
    f.read(reinterpret_cast<char *>(params_->getData()),
           sizeof(float) * params_->getSize());
    if (f.fail())
...
void ModelSession::prefill(Text<size_t, 2> &tokens) {
  impl_->prefillFn(&impl_->abi, params_.get(), &tokens);
...
void ModelSession::decode(int tokenId) {
  ...
  auto &a = impl_->abi;
  impl_->decodeFn(
      &a, params_.get(), decodeTokenInput_.get(), cachePosition_.get(),
      &a.kv(0), &a.kv(1), &a.kv(2), &a.kv(3), &a.kv(4), &a.kv(5), &a.kv(6),
      &a.kv(7), &a.kv(8), &a.kv(9), &a.kv(10), &a.kv(11), &a.kv(12), &a.kv(13),
      &a.kv(14), &a.kv(15), &a.kv(16), &a.kv(17), &a.kv(18), &a.kv(19),
      &a.kv(20), &a.kv(21), &a.kv(22), &a.kv(23), &a.kv(24), &a.kv(25),
      &a.kv(26), &a.kv(27), &a.kv(28), &a.kv(29), &a.kv(30), &a.kv(31),
      &a.kv(32), &a.kv(33), &a.kv(34), &a.kv(35), &a.kv(36), &a.kv(37),
      &a.kv(38), &a.kv(39), &a.kv(40), &a.kv(41), &a.kv(42), &a.kv(43),
      &a.kv(44), &a.kv(45), &a.kv(46), &a.kv(47), &a.kv(48), &a.kv(49),
      &a.kv(50), &a.kv(51), &a.kv(52), &a.kv(53), &a.kv(54), &a.kv(55));
...
bool ModelSession::handleKVCacheOverflow(int keepTokenNum, float ropeTheta) {
  ...
  // Extract raw pointers from KV cache MemRefs for kvcache helpers.
...
//===----------------------------------------------------------------------===//
// Shape constants remain at compile-time defaults from macros;
// createFromRax() only sets cfg.modelSoPath from the manifest.
