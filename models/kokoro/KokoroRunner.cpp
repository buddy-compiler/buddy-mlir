...
void KokoroRunner::run(const RunConfig &cfgIn) {
  RunConfig cfg = cfgIn;
  if (!cfg.suppressStats) std::cerr << "\033[35;1mKokoro-82M TTS Inference (buddy-cli / BuddyRuntime)\033[0m\n";
  ...
  std::cout << "Kokoro TTS inference done.\n";
} } }
