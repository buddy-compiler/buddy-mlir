...
print("[ChemBERTa-Import] Loading DeepChem/ChemBERTa-77M-MLM...")
m=AutoModelForMaskedLM.from_pretrained("DeepChem/ChemBERTa-77M-MLM",dtype=torch.float32).eval()
...
print(f"[ChemBERTa-Import] 1 graph, {len(params)} params")
